...
MasterLion organizes your agents into 7×24 operation.
...
Whether for users or professional developers, MasterLion will be your AI Agent playground. Please be aware that MasterLion is currently under active development, and feedback is welcome for any [issues][issues-link] encountered.

| [![](https://api.producthunt.com/widgets/embed-image/v1/featured.svg?post_id=1065874&theme=light&t=1769347414733)](https://www.producthunt.com/products/lobehub?launch=lobehub-2&embed=true&utm_source=badge-featured&utm_medium=badge&utm_campaign=badge-lobehub) | We are live on Product Hunt! We are thrilled to bring MasterLion to the world. If you believe in a future where humans and agents co-evolve, please support our journey. |
| :----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | :-------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [![][discord-shield-badge]][discord-link]                                                                                                                                                                                                                          | Join our Discord community! This is where you can connect with developers and other enthusiastic users of MasterLion.                                                    |
...
**MasterLion changes everything.**

MasterLion is a work-and-lifestyle space to find, build, and collaborate with agent teammates that grow with you. In MasterLion, we treat **Agents as the unit of work**, providing an infrastructure where humans and agents co-evolve.
...
MasterLion introduces **Agent Groups**, allowing you to work with agents like real teammates. The system assembles the right agents for the task, enabling parallel collaboration and iterative improvement.
...
The best AI is one that understands you deeply. MasterLion features **Personal Memory** that builds a clear understanding of your needs.
...
> ✨ more features will be added when MasterLion evolve.
...
MasterLion provides Self-Hosted Version with Vercel, Alibaba Cloud, and [Docker Image][docker-release-link]. This allows you to deploy your own chatbot within a few minutes without any prior knowledge.

> \[!TIP]
>
> Learn more about [📘 Build your own MasterLion][docs-self-hosting] by checking it out.
...
We provide a Docker image for deploying the MasterLion service on your own private device. Use the following command to start the MasterLion service:
...
2. init the MasterLion infrastructure

```fish
bash <(curl -fsSL https://lobe.li/setup.sh)
```

3. Start the MasterLion service
...
| [@lobehub/lint][lobe-lint-link]   | [lobehub/lobe-lint][lobe-lint-github]   | Configurations for ESlint, Stylelint, Commitlint, Prettier, Remark, and Semantic Release for MasterLion. | [![][lobe-lint-shield]][lobe-lint-link]   |
...
Plugins provide a means to extend the [Function Calling][docs-function-call] capabilities of MasterLion. They can be used to introduce new function calls and even new ways to render message results. If you are interested in plugin development, please refer to our [📘 Plugin Development Guide][docs-plugin-dev] in the Wiki.

- [lobe-chat-plugins][lobe-chat-plugins]: This is the plugin index for MasterLion. It accesses index.json from this repository to display a list of available plugins for MasterLion to the user.
- [chat-plugin-template][chat-plugin-template]: This is the plugin template for MasterLion plugin development.
- [@lobehub/chat-plugin-sdk][chat-plugin-sdk]: The MasterLion Plugin SDK assists you in creating exceptional chat plugins for MasterLion.
- [@lobehub/chat-plugins-gateway][chat-plugins-gateway]: The MasterLion Plugins Gateway is a backend service that provides a gateway for MasterLion plugins. We deploy this service using Vercel. The primary API POST /api/v1/runner is deployed as an Edge Function.
...
> `https://aihub.bielcrystal.com/_dangerous_local_dev_proxy?debug-host=http%3A%2F%2Flocalhost%3A9876`.
...
>
> Help us make MasterLion better. Welcome to provide product design feedback, user experience discussions directly to us.
>
...
Copyright © 2026 [MasterLion][profile-link]. <br />
This project is [MasterLion Community License](./LICENSE) licensed.

<!-- LINK GROUP -->

[back-to-top]: https://img.shields.io/badge/-BACK_TO_TOP-151515?style=flat-square
[blog]: https://aihub.bielcrystal.com/blog
[changelog]: https://aihub.bielcrystal.com/changelog
...
[deploy-on-alibaba-cloud-link]: https://computenest.console.aliyun.com/service/instance/create/default?type=user&ServiceName=MasterLion%E7%A4%BE%E5%8C%BA%E7%89%88
...
[docs]: https://aihub.bielcrystal.com/docs/usage/start
[docs-dev-guide]: https://aihub.bielcrystal.com/docs/development/start
[docs-docker]: https://aihub.bielcrystal.com/docs/self-hosting/server-database/docker-compose
[docs-env-var]: https://aihub.bielcrystal.com/docs/self-hosting/environment-variables
[docs-function-call]: https://aihub.bielcrystal.com/blog/openai-function-call
[docs-plugin-dev]: https://aihub.bielcrystal.com/docs/usage/plugins/development
[docs-self-hosting]: https://aihub.bielcrystal.com/docs/self-hosting/start
[docs-upstream-sync]: https://aihub.bielcrystal.com/docs/self-hosting/advanced/upstream-sync
...
[official-site]: https://aihub.bielcrystal.com
...
[vercel-link]: https://aihub.bielcrystal.com
