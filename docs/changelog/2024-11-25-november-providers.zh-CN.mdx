...
description: MasterLion 新增支持 Gitee AI、InternLM、xAI 和 Cloudflare Workers AI， 为团队提供更多模型接入选择。
tags:
  - MasterLion
  - AI 模型服务
  - Gitee AI
...
还需要其他服务商支持？在 [GitHub Issues](https://github.com/biel-cc/MasterLion/issues/new/choose) 告诉我们优先支持哪些。
