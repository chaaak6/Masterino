...
Provider 管理系统已彻底重构。现在你可以添加自己的 AI 服务商，编辑现有配置，并设置自定义模型的具体能力参数。开源版和 [MasterLion Cloud](https://aihub.bielcrystal.com) 均已上线。
...
对 Provider 管理系统有建议？欢迎在 [GitHub Issues](https://github.com/biel-cc/MasterLion/issues/new/choose) 参与讨论。
