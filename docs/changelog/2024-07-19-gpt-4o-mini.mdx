---
title: 'Masterino v1.6: GPT-4o Mini Joins the Default Lineup'
description: >-
  Masterino v1.6 adds GPT-4o mini support, while Masterino Cloud upgrades its
...
# Masterino v1.6: GPT-4o Mini Joins the Default Lineup

OpenAI's full model family has moved to GPT-4. Masterino v1.6 follows that shift, adding GPT-4o mini to the supported models. For Masterino Cloud users, this upgrade goes further: GPT-4o mini is now the default, replacing GPT-3.5-turbo.
...
For Masterino Cloud users, the service upgrade is automatic. New conversations start with GPT-4o mini by default. Existing users don't need to change any settings—the model switcher simply shows the new default first.
...
- Updated Masterino Cloud default model selection logic
