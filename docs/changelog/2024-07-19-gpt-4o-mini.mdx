---
title: 'MasterLion v1.6: GPT-4o Mini Joins the Default Lineup'
description: >-
  MasterLion v1.6 adds GPT-4o mini support, while MasterLion Cloud upgrades its
...
# MasterLion v1.6: GPT-4o Mini Joins the Default Lineup

OpenAI's full model family has moved to GPT-4. MasterLion v1.6 follows that shift, adding GPT-4o mini to the supported models. For MasterLion Cloud users, this upgrade goes further: GPT-4o mini is now the default, replacing GPT-3.5-turbo.
...
For MasterLion Cloud users, the service upgrade is automatic. New conversations start with GPT-4o mini by default. Existing users don't need to change any settings—the model switcher simply shows the new default first.
...
- Updated MasterLion Cloud default model selection logic
