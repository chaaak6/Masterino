---
title: Masterion Adds Support for OpenAI O1 Series Models
description: >-
  Masterion v1.17.0 now supports OpenAI's latest o1-preview and o1-mini models,
...
Masterion v1.17.0 now supports OpenAI's newly launched O1 series models. This update is available for both community edition users and [Cloud version](https://aihub.bielcrystal.com) subscribers.
...
Both models are available now in the model selector for all Masterion users.
...
With this release, Masterion continues to track the latest model ecosystem. We look forward to seeing what you build with the O1 series.
