...
MasterLion v1.17.0 now supports OpenAI's newly launched O1 series models. This update is available for both community edition users and [Cloud version](https://MasterLion.com) subscribers.
...
- [Cloud version](https://MasterLion.com) subscribers can use O1 models immediately
