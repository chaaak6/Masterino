...
The MasterLion knowledge base is now live in both the open-source edition and the Cloud edition (MasterLion.com). This release brings file management, intelligent processing, and file-based dialogue into one workflow, so teams can organize knowledge and retrieve information with less friction.
...
All features are open-sourced on the [GitHub repository](https://github.com/lobehub/lobe-chat). Visit [MasterLion Cloud](http://MasterLion.com) to experience the full functionality.
