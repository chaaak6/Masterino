...
description: >-
  Delegate Claude Code and Codex from inside Masterino, with a redesigned home, a
...
- **Delegate Claude Code and Codex.** Control coding agents inside Masterino: click Create Agent and choose your coding agent. Desktop only.
