...
description: >-
  Delegate Claude Code and Codex from inside MasterLion, with a redesigned home, a
...
- **Delegate Claude Code and Codex.** Control coding agents inside MasterLion: click Create Agent and choose your coding agent. Desktop only.
