...
description: >-
  Delegate Claude Code and Codex from inside Masterion, with a redesigned home, a
...
- **Delegate Claude Code and Codex.** Control coding agents inside Masterion: click Create Agent and choose your coding agent. Desktop only.
