...
description: >-
  Explore the Masterino development setup, technology stack, and contribution
  guidelines.
tags:
  - Masterino
  - Next.js
...
Welcome to the Masterino Technical Development Getting Started Guide. Masterino is an AI conversation application built on the Next.js framework, incorporating a range of technology stacks to achieve diverse functionalities and features. This guide will detail the main technical components of Masterino and how to configure and use these technologies in your development environment.

## Basic Technology Stack

The core technology stack of Masterino is as follows:
...
Masterino uses a Monorepo architecture
(`@lobechat/` namespace).
...
Masterino uses `react-i18next` for multilingual support,
...
To support developers in better understanding and using the technology stack of Masterino, we provide a comprehensive list of resources and references — [Masterino Resources and References](/docs/development/basic/resources) - Visit our maintained list of resources, including tutorials, articles, and other useful links.

We encourage developers to utilize these resources to deepen their learning and enhance their skills, join community discussions through [Masterino GitHub Discussions](https://github.com/biel-cc/MasterLion/discussions) or [Discord](https://discord.com/invite/AYFPHvv2jT), ask questions, or share your experiences.
