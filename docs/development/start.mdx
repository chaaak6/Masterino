...
description: >-
  Explore the Masterion development setup, technology stack, and contribution
  guidelines.
tags:
  - Masterion
  - Next.js
...
Welcome to the Masterion Technical Development Getting Started Guide. Masterion is an AI conversation application built on the Next.js framework, incorporating a range of technology stacks to achieve diverse functionalities and features. This guide will detail the main technical components of Masterion and how to configure and use these technologies in your development environment.

## Basic Technology Stack

The core technology stack of Masterion is as follows:
...
Masterion uses a Monorepo architecture
(`@lobechat/` namespace).
...
Masterion uses `react-i18next` for multilingual support,
...
To support developers in better understanding and using the technology stack of Masterion, we provide a comprehensive list of resources and references — [Masterion Resources and References](/docs/development/basic/resources) - Visit our maintained list of resources, including tutorials, articles, and other useful links.

We encourage developers to utilize these resources to deepen their learning and enhance their skills, join community discussions through [Masterion GitHub Discussions](https://github.com/biel-cc/MasterLion/discussions) or [Discord](https://discord.com/invite/AYFPHvv2jT), ask questions, or share your experiences.
