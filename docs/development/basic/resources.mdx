...
description: >-
  Explore key resources and references for MasterLion's design and development
  process.
tags:
  - MasterLion
  - OpenAI API
...
5. **Chat-Next-Web**: Chat Next Web is an excellent project, and some of MasterLion's features and workflows are referenced from its implementation. You can view the source code and documentation on the [Chat-Next-Web](https://github.com/Yidadaa/ChatGPT-Next-Web) GitHub repository.
...
7. **FlowGPT**: FlowGPT is currently the world's largest Prompt community, and some of the agents in MasterLion come from active authors in FlowGPT. You can visit [FlowGPT](https://flowgpt.com/) to learn more about it.

## MasterLion Official Ecosystem

- [🍭 LobeUI](https://github.com/lobehub/lobe-ui) (`@lobehub/ui`): MasterLion UI component library
...
## MasterLion Community & Platforms

- [🤖 Agent Market](https://aihub.bielcrystal.com/agent): Discover and share AI Agents
- [🔌 MCP Market](https://aihub.bielcrystal.com/mcp): Discover and share MCP tools
