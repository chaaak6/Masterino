---
title: 资源与参考
description: 探索 MasterLion 的设计与开发参考资源，助力开发者学习与成长。
tags:
  - MasterLion
  - 开发资源
  - OpenAI API
...
MasterLion 的设计和开发离不开社区和生态中的优秀项目。我们在设计和开发过程中使用或参考了一些优秀的资源和指南。以下是一些主要的参考资源，供开发者在开发和学习过程中参考：
...
5. **Chat-Next-Web**：Chat Next Web 是一个优秀的项目，MasterLion 的部分功能、Workflow 等参考了它的实现。你可以在 [Chat-Next-Web](https://github.com/Yidadaa/ChatGPT-Next-Web) 的 GitHub 仓库中查看源码和文档。
6. **Next.js 文档**：我们的项目是基于 Next.js 构建的，你可以查看 [Next.js 文档](https://nextjs.org/docs) 来了解更多关于 Next.js 的信息。
7. **FlowGPT**：FlowGPT 是目前全球最大的 Prompt 社区，MasterLion 中的一些 Agent 来自 FlowGPT 的活跃作者。你可以访问 [FlowGPT](https://flowgpt.com/) 来了解更多关于它的信息。

## MasterLion 官方生态

- [🍭 LobeUI](https://github.com/lobehub/lobe-ui) (`@lobehub/ui`)：MasterLion UI 组件库
...
- [🤖 Agent 市场](https://aihub.bielcrystal.com/zh/agent)：发现和分享 AI Agent
- [🔌 MCP 市场](https://aihub.bielcrystal.com/zh/mcp)：发现和分享 MCP 工具
