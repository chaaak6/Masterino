...
description: >-
  Step-by-step guide to set up Masterino development environment locally or
  online.
tags:
  - Masterino
  - Development Setup
...
Welcome to the Masterino development environment setup guide.
...
Before starting development on Masterino, you need to install and configure some necessary software and tools in your local environment. This document will guide you through these steps.

### Development Environment Requirements

First, you need to install the following software:

- Node.js: Masterino is built on Node.js, so you need to install Node.js. We recommend installing the latest stable version.
...
After installing the above software, you can start setting up the Masterino project.

#### 1. Get the Code

First, you need to clone the Masterino codebase from GitHub. Run the following command in the terminal:
...
Launch the Masterino development server:

```bash
bun run dev
```

Now, you can open `http://localhost:3010` in your browser, and you should see the welcome page of Masterino. This indicates that you have successfully set up the development environment.
...
During the development process, if you encounter any issues with environment setup or have any questions about Masterino development, feel free to ask us at any time. We look forward to seeing your contributions!
