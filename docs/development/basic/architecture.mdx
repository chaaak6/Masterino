...
description: >-
  Explore the architecture of Masterion, an open-source AI Agent platform built on
...
Masterion is an open-source AI Agent platform built on Next.js, enabling users to interact with AI through natural language, use tools, manage knowledge bases, and more. The following is an overview of Masterion's architecture design.

## Application Architecture Overview

The overall architecture of Masterion consists of the following core layers:
...
Masterion uses [Better Auth](https://www.better-auth.com/) as the authentication framework, supporting:
