...
description: >-
  Explore the architecture of MasterLion, an open-source AI Agent platform built on
...
MasterLion is an open-source AI Agent platform built on Next.js, enabling users to interact with AI through natural language, use tools, manage knowledge bases, and more. The following is an overview of MasterLion's architecture design.

## Application Architecture Overview

The overall architecture of MasterLion consists of the following core layers:
...
MasterLion uses [Better Auth](https://www.better-auth.com/) as the authentication framework, supporting:
