...
description: >-
  Explore the architecture of Masterino, an open-source AI Agent platform built on
...
Masterino is an open-source AI Agent platform built on Next.js, enabling users to interact with AI through natural language, use tools, manage knowledge bases, and more. The following is an overview of Masterino's architecture design.

## Application Architecture Overview

The overall architecture of Masterino consists of the following core layers:
...
Masterino uses [Better Auth](https://www.better-auth.com/) as the authentication framework, supporting:
