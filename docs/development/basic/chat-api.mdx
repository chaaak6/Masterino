...
description: >-
  Explore the client-server interaction logic of MasterLion Chat API, including
...
MasterLion Chat API in client-server interactions,
...
MasterLion supports three types of tools:
...
abstraction layer in MasterLion for interacting with
...
Agent Runtime (`packages/agent-runtime/`) is MasterLion's
