...
description: >-
  Explore the client-server interaction logic of Masterion Chat API, including
...
Masterion Chat API in client-server interactions,
...
Masterion supports three types of tools:
...
abstraction layer in Masterion for interacting with
...
Agent Runtime (`packages/agent-runtime/`) is Masterion's
