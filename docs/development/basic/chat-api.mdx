...
description: >-
  Explore the client-server interaction logic of Masterino Chat API, including
...
Masterino Chat API in client-server interactions,
...
Masterino supports three types of tools:
...
abstraction layer in Masterino for interacting with
...
Agent Runtime (`packages/agent-runtime/`) is Masterino's
