...
<AccordionGroup>
  <Accordion title="Built-in Skills">
    Pre-installed skills that ship with MasterLion:
    ...
    Built-in skills are maintained by the MasterLion team and automatically updated.
  </Accordion>

  <Accordion title="Market Skills">
    Community-created skills available from the MasterLion marketplace:
...
MasterLion includes several powerful built-in tools:
...
Extend agent capabilities with plugins from the MasterLion marketplace:
...
MCP is MasterLion's system for connecting agents to external tools and services — databases, APIs, file systems, development tools, and business applications.
