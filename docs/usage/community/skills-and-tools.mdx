...
<AccordionGroup>
  <Accordion title="Built-in Skills">
    Pre-installed skills that ship with Masterino:
    ...
    Built-in skills are maintained by the Masterino team and automatically updated.
  </Accordion>

  <Accordion title="Market Skills">
    Community-created skills available from the Masterino marketplace:
...
Masterino includes several powerful built-in tools:
...
Extend agent capabilities with plugins from the Masterino marketplace:
...
MCP is Masterino's system for connecting agents to external tools and services — databases, APIs, file systems, development tools, and business applications.
