...
<AccordionGroup>
  <Accordion title="Built-in Skills">
    Pre-installed skills that ship with Masterion:
    ...
    Built-in skills are maintained by the Masterion team and automatically updated.
  </Accordion>

  <Accordion title="Market Skills">
    Community-created skills available from the Masterion marketplace:
...
Masterion includes several powerful built-in tools:
...
Extend agent capabilities with plugins from the Masterion marketplace:
...
MCP is Masterion's system for connecting agents to external tools and services — databases, APIs, file systems, development tools, and business applications.
