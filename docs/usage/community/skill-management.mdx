...
| ------------------------ | ------------------------------------ | ----------------------------------------- |
| **Built-in tools**       | Capabilities built into Masterion      | Artifacts, Sandbox, GTD, Notebook, Memory |
| **Masterion Integrations** | OAuth-connected third-party services | Linear, Microsoft, Twitter                |
...
- **Masterion** — Built-in tools and Masterion-native integrations (Linear, Microsoft, Twitter, Composio services)
...
Built-in tools (Artifacts, Sandbox, GTD, Notebook) are pre-installed — you can enable them for any Agent immediately. Masterion Integrations and Composio services require an OAuth connection:

1. In the Skill Store, go to the **Masterion** tab
...
**Integrations** — Built-in tools, Masterion-connected services, and Composio integrations. Each shows its connection status. Click **Connect** or **Disconnect** to manage the OAuth link.
