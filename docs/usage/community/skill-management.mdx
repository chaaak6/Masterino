...
| ------------------------ | ------------------------------------ | ----------------------------------------- |
| **Built-in tools**       | Capabilities built into Masterino      | Artifacts, Sandbox, GTD, Notebook, Memory |
| **Masterino Integrations** | OAuth-connected third-party services | Linear, Microsoft, Twitter                |
...
- **Masterino** — Built-in tools and Masterino-native integrations (Linear, Microsoft, Twitter, Composio services)
...
Built-in tools (Artifacts, Sandbox, GTD, Notebook) are pre-installed — you can enable them for any Agent immediately. Masterino Integrations and Composio services require an OAuth connection:

1. In the Skill Store, go to the **Masterino** tab
...
**Integrations** — Built-in tools, Masterino-connected services, and Composio integrations. Each shows its connection status. Click **Connect** or **Disconnect** to manage the OAuth link.
