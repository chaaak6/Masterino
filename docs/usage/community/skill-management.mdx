...
| ------------------------ | ------------------------------------ | ----------------------------------------- |
| **Built-in tools**       | Capabilities built into MasterLion      | Artifacts, Sandbox, GTD, Notebook, Memory |
| **MasterLion Integrations** | OAuth-connected third-party services | Linear, Microsoft, Twitter                |
...
- **MasterLion** — Built-in tools and MasterLion-native integrations (Linear, Microsoft, Twitter, Composio services)
...
Built-in tools (Artifacts, Sandbox, GTD, Notebook) are pre-installed — you can enable them for any Agent immediately. MasterLion Integrations and Composio services require an OAuth connection:

1. In the Skill Store, go to the **MasterLion** tab
...
**Integrations** — Built-in tools, MasterLion-connected services, and Composio integrations. Each shows its connection status. Click **Connect** or **Disconnect** to manage the OAuth link.
