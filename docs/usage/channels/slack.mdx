...
description: >-
  Learn how to create a Slack app and connect it to your Masterino agent as a
...
Click **Test Connection** in Masterino, then go to Slack, invite the bot to a channel, and mention it with `@MasterLion Assistant` to confirm it responds.
