---
title: Connect Masterion to Discord
description: >-
  Learn how to create a Discord bot and connect it to your Masterion agent as a
...
# Connect Masterion to Discord

By connecting a Discord channel to your Masterion agent, users can interact with the AI assistant directly through Discord server channels and direct messages.
...
<Steps>
  ...
  Visit the [Discord Developer Portal](https://discord.com/developers/applications) and click **New Application**. Give your application a name (e.g., "Masterion Assistant") and click **Create**.
...
## Step 2: Configure Discord in Masterion

<Steps>
  ### Open Channel Settings

  In Masterion, navigate to your agent's settings, then select the **Channels** tab. Click **Discord** from the platform list.
  ...
  Click **Save Configuration**. Your credentials will be saved and Masterion will start listening for Discord events.
</Steps>
...
Back in Masterion's channel settings for Discord, click **Test Connection** to verify everything is configured correctly. Then send a message to your bot on Discord to confirm it responds.
...
To get it: in Discord, open **User Settings → Advanced** and turn on **Developer Mode**. Then right-click your own username anywhere in Discord and choose **Copy User ID**. Paste the numeric ID into **Your Platform User ID** in Masterion's Advanced Settings.
...
To get it: with **Developer Mode** on, right-click the server name in your server list and choose **Copy Server ID**. Paste it into **Default Server** in Masterion's Advanced Settings.

## Access Policies

Masterion gates inbound traffic with three layered settings, all under **Advanced Settings** and all defaulting to permissive.
