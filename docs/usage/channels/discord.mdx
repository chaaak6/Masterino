---
title: Connect MasterLion to Discord
description: >-
  Learn how to create a Discord bot and connect it to your MasterLion agent as a
...
# Connect MasterLion to Discord

By connecting a Discord channel to your MasterLion agent, users can interact with the AI assistant directly through Discord server channels and direct messages.
...
<Steps>
  ...
  Visit the [Discord Developer Portal](https://discord.com/developers/applications) and click **New Application**. Give your application a name (e.g., "MasterLion Assistant") and click **Create**.
...
## Step 2: Configure Discord in MasterLion

<Steps>
  ### Open Channel Settings

  In MasterLion, navigate to your agent's settings, then select the **Channels** tab. Click **Discord** from the platform list.
  ...
  Click **Save Configuration**. Your credentials will be saved and MasterLion will start listening for Discord events.
</Steps>
...
Back in MasterLion's channel settings for Discord, click **Test Connection** to verify everything is configured correctly. Then send a message to your bot on Discord to confirm it responds.
...
To get it: in Discord, open **User Settings → Advanced** and turn on **Developer Mode**. Then right-click your own username anywhere in Discord and choose **Copy User ID**. Paste the numeric ID into **Your Platform User ID** in MasterLion's Advanced Settings.
...
To get it: with **Developer Mode** on, right-click the server name in your server list and choose **Copy Server ID**. Paste it into **Default Server** in MasterLion's Advanced Settings.

## Access Policies

MasterLion gates inbound traffic with three layered settings, all under **Advanced Settings** and all defaulting to permissive.
