...
MasterLion provides comprehensive file upload capabilities, enabling AI agents to access, analyze, and reference documents, images, code, and other files during conversations.
...
MasterLion includes an integrated file viewer:
...
- Files are stored in your MasterLion instance
