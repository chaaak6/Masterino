...
Click the **Share** button in the top-right corner of the chat window to export and share your current conversation. Masterion supports multiple formats — choose the one that fits how you want to use it.
...
- **Default** — Masterion's standard JSON format
