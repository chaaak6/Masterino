---
title: Using GitHub Models in Masterion
description: >-
  Learn how to configure and use GitHub's API Key in Masterion to start
...
# Using GitHub Models in Masterion
...
This guide will walk you through how to use GitHub Models within Masterion.
...
<Steps>
  ...
  ### Step 2: Configure GitHub Models in Masterion
...
And that’s it! You’re now ready to start using GitHub-provided models in Masterion for conversations and interactions.
