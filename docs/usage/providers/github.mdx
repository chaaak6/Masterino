---
title: Using GitHub Models in Masterino
description: >-
  Learn how to configure and use GitHub's API Key in Masterino to start
...
# Using GitHub Models in Masterino
...
This guide will walk you through how to use GitHub Models within Masterino.
...
<Steps>
  ...
  ### Step 2: Configure GitHub Models in Masterino
...
And that’s it! You’re now ready to start using GitHub-provided models in Masterino for conversations and interactions.
