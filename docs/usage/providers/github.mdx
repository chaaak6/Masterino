---
title: Using GitHub Models in MasterLion
description: >-
  Learn how to configure and use GitHub's API Key in MasterLion to start
...
# Using GitHub Models in MasterLion
...
This guide will walk you through how to use GitHub Models within MasterLion.
...
<Steps>
  ...
  ### Step 2: Configure GitHub Models in MasterLion
...
And that’s it! You’re now ready to start using GitHub-provided models in MasterLion for conversations and interactions.
