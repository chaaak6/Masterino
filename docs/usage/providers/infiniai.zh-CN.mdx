---
title: 在 Masterino 中使用无问芯穹
description: 学习如何在 Masterino 中配置和使用无问芯穹的 API Key，实现 AI 对话交互。
tags:
  - Masterino
  - 无问芯穹
  - API密钥
...
本文将指导你如何在 Masterino 中快速接入无问芯穹的 AI 能力。
...
<Steps>
  ...
  ### 步骤二：配置 Masterino 模型服务

  - 打开 Masterino 进入「设置」界面
