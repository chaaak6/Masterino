---
title: Using Vercel AI Gateway in MasterLion
description: Learn how to integrate and use the unified API of Vercel AI Gateway in MasterLion
tags:
  - MasterLion
  - Vercel AI Gateway
  - API Key
...
# Using Vercel AI Gateway in MasterLion
...
This guide will walk you through how to use Vercel AI Gateway within MasterLion.
...
<Steps>
  ...
  ### Step 2: Configure Vercel AI Gateway in MasterLion
...
That's it! You can now start chatting in MasterLion using models provided by Vercel AI Gateway.
