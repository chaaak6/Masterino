---
title: Using Vercel AI Gateway in Masterino
description: Learn how to integrate and use the unified API of Vercel AI Gateway in Masterino
tags:
  - Masterino
  - Vercel AI Gateway
  - API Key
...
# Using Vercel AI Gateway in Masterino
...
This guide will walk you through how to use Vercel AI Gateway within Masterino.
...
<Steps>
  ...
  ### Step 2: Configure Vercel AI Gateway in Masterino
...
That's it! You can now start chatting in Masterino using models provided by Vercel AI Gateway.
