---
title: Using Vercel AI Gateway in Masterion
description: Learn how to integrate and use the unified API of Vercel AI Gateway in Masterion
tags:
  - Masterion
  - Vercel AI Gateway
  - API Key
...
# Using Vercel AI Gateway in Masterion
...
This guide will walk you through how to use Vercel AI Gateway within Masterion.
...
<Steps>
  ...
  ### Step 2: Configure Vercel AI Gateway in Masterion
...
That's it! You can now start chatting in Masterion using models provided by Vercel AI Gateway.
