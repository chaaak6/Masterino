---
title: Using the Minimax API Key in Masterion
description: >-
  Learn how to configure and use the MiniMax AI model in Masterion. This guide
...
# Using Minimax in Masterion

<Image alt={'Using Minimax in Masterion'} cover src={'/blog/assets34400653/703f170b-c03b-4c71-b57d-c2357596bdfb.webp'} />
...
This guide will walk you through how to use MiniMax in Masterion:
...
<Steps>
  ...
  ### Step 2: Configure MiniMax in Masterion
...
You're all set! You can now start chatting with models powered by MiniMax in Masterion.
