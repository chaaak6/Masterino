---
title: Using the Minimax API Key in MasterLion
description: >-
  Learn how to configure and use the MiniMax AI model in MasterLion. This guide
...
# Using Minimax in MasterLion

<Image alt={'Using Minimax in MasterLion'} cover src={'/blog/assets34400653/703f170b-c03b-4c71-b57d-c2357596bdfb.webp'} />
...
This guide will walk you through how to use MiniMax in MasterLion:
...
<Steps>
  ...
  ### Step 2: Configure MiniMax in MasterLion
...
You're all set! You can now start chatting with models powered by MiniMax in MasterLion.
