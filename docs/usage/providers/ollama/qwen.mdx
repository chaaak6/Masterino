---
title: Using the Local Qwen Model in MasterLion
description: >-
  Easily chat with the locally deployed Qwen model through MasterLion's integration
  with Ollama. Learn how to install and select the Qwen model.
tags:
  - Qwen
  - Qwen Model
  - MasterLion Integration
  - Ollama
  - Local Deployment
---
...
<Image alt={'Using Qwen in MasterLion'} cover src={'/blog/assets17870709/b4a01219-e7b1-48a0-888c-f0271b18e3a6.webp'} />
...
Now, thanks to MasterLion’s integration with [Ollama](https://ollama.com/), you can easily use the Qwen model locally within MasterLion.

This guide will walk you through how to use the locally deployed Qwen model in MasterLion:
...
You’re now ready to start chatting with the local Qwen model in MasterLion.
