---
title: Using the Local Qwen Model in Masterino
description: >-
  Easily chat with the locally deployed Qwen model through Masterino's integration
  with Ollama. Learn how to install and select the Qwen model.
tags:
  - Qwen
  - Qwen Model
  - Masterino Integration
  - Ollama
  - Local Deployment
---
...
<Image alt={'Using Qwen in Masterino'} cover src={'/blog/assets17870709/b4a01219-e7b1-48a0-888c-f0271b18e3a6.webp'} />
...
Now, thanks to Masterino’s integration with [Ollama](https://ollama.com/), you can easily use the Qwen model locally within Masterino.

This guide will walk you through how to use the locally deployed Qwen model in Masterino:
...
You’re now ready to start chatting with the local Qwen model in Masterino.
