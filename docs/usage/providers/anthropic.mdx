---
title: Using the Anthropic Claude API Key in Masterion
description: >-
  Learn how to configure and use the Anthropic Claude API in Masterion, including
...
# Using Anthropic Claude in Masterion

<Image alt={'Using Anthropic Claude in Masterion'} cover src={'/blog/assets17870709/620b956b-dcb2-442a-8bb1-9aa22681dfa4.webp'} />

The Anthropic Claude API is now publicly available. This guide will walk you through how to use [Anthropic Claude](https://www.anthropic.com/api) in Masterion:
...
<Steps>
  ...
  ### Step 2: Configure Anthropic Claude in Masterion
...
That's it! You’re now ready to use Anthropic Claude models in Masterion for conversations.
