---
title: Using Google Gemini API Key in MasterLion
description: >-
  This guide will walk you through how to configure and use Google Gemini, a
  powerful language model developed by Google AI, within MasterLion.
tags:
  - Google Gemini
  - Google AI
  - API Key
...
# Using Google Gemini in MasterLion

<Image alt={'Using Google Gemini in MasterLion'} cover src={'/blog/assets34400653/9a8dc1d4-152b-415f-a7cd-8f0c8fbb9913.webp'} />
...
This guide will show you how to use Google Gemini in MasterLion:
...
<Steps>
  ...
  ### Step 2: Configure Google Gemini in MasterLion

  - Go to the Settings page in MasterLion
  - Under "AI Providers", locate the "Google Gemini" section

  <Image alt={'Enter Google Gemini API Key in MasterLion'} inStep src={'/blog/assets34400653/11442ce4-a615-49c4-937a-ca2ae93dd27c.webp'} />
...
And that’s it — you’re now ready to use Google Gemini in MasterLion!
