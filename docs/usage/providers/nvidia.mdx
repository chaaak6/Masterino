---
title: Using Nvidia NIM API Key in MasterLion
description: >-
  Learn how to configure and use Nvidia NIM AI models in MasterLion, obtain your
...
# Using Nvidia NIM in MasterLion

<Image alt={'Using Nvidia NIM in MasterLion'} cover src={'/blog/assetsd8927338578c426b833e5cb57e0b57ec.webp'} />
...
This guide will walk you through how to integrate and use AI models provided by Nvidia NIM in MasterLion:
...
<Steps>
  ...
  ### Step 2: Configure Nvidia NIM in MasterLion

  - Go to the `App Settings` section in MasterLion and navigate to `AI Service Providers`.
...
That’s it! You’re now ready to use Nvidia NIM-powered models in MasterLion for your conversations.
