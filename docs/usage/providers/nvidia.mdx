---
title: Using Nvidia NIM API Key in Masterion
description: >-
  Learn how to configure and use Nvidia NIM AI models in Masterion, obtain your
...
# Using Nvidia NIM in Masterion

<Image alt={'Using Nvidia NIM in Masterion'} cover src={'/blog/assetsd8927338578c426b833e5cb57e0b57ec.webp'} />
...
This guide will walk you through how to integrate and use AI models provided by Nvidia NIM in Masterion:
...
<Steps>
  ...
  ### Step 2: Configure Nvidia NIM in Masterion

  - Go to the `App Settings` section in Masterion and navigate to `AI Service Providers`.
...
That’s it! You’re now ready to use Nvidia NIM-powered models in Masterion for your conversations.
