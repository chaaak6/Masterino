---
title: Using Nvidia NIM API Key in Masterino
description: >-
  Learn how to configure and use Nvidia NIM AI models in Masterino, obtain your
...
# Using Nvidia NIM in Masterino

<Image alt={'Using Nvidia NIM in Masterino'} cover src={'/blog/assetsd8927338578c426b833e5cb57e0b57ec.webp'} />
...
This guide will walk you through how to integrate and use AI models provided by Nvidia NIM in Masterino:
...
<Steps>
  ...
  ### Step 2: Configure Nvidia NIM in Masterino

  - Go to the `App Settings` section in Masterino and navigate to `AI Service Providers`.
...
That’s it! You’re now ready to use Nvidia NIM-powered models in Masterino for your conversations.
