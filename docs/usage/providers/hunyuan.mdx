---
title: Using Tencent Hunyuan in MasterLion
description: >-
  Learn how to configure and use Tencent Hunyuan's API Key in MasterLion to start
...
# Using Tencent Hunyuan in MasterLion
...
This guide will walk you through how to use Tencent Hunyuan in MasterLion.
...
<Steps>
  ...
  ### Step 2: Configure Tencent Hunyuan in MasterLion
...
And that’s it! You’re now ready to use Tencent Hunyuan’s models for conversations in MasterLion.
