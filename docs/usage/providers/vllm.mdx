---
title: Using vLLM API Key in MasterLion
description: >-
  Learn how to configure and use vLLM language models in MasterLion, obtain an API
...
# Using vLLM in MasterLion

<Image alt={'Using vLLM in MasterLion'} cover src={'/blog/assets1049abec5850cebf8ce12cd50199b9c5.webp'} />
...
This guide will walk you through how to use vLLM in MasterLion:
...
<Steps>
  ...
  ### Step 4: Configure vLLM in MasterLion

  - Open the `App Settings` panel in MasterLion
...
You're now ready to use vLLM-powered models in MasterLion for conversations.
