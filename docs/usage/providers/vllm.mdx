---
title: Using vLLM API Key in Masterino
description: >-
  Learn how to configure and use vLLM language models in Masterino, obtain an API
...
# Using vLLM in Masterino

<Image alt={'Using vLLM in Masterino'} cover src={'/blog/assets1049abec5850cebf8ce12cd50199b9c5.webp'} />
...
This guide will walk you through how to use vLLM in Masterino:
...
<Steps>
  ...
  ### Step 4: Configure vLLM in Masterino

  - Open the `App Settings` panel in Masterino
...
You're now ready to use vLLM-powered models in Masterino for conversations.
