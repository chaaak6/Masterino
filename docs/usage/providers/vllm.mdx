---
title: Using vLLM API Key in Masterion
description: >-
  Learn how to configure and use vLLM language models in Masterion, obtain an API
...
# Using vLLM in Masterion

<Image alt={'Using vLLM in Masterion'} cover src={'/blog/assets1049abec5850cebf8ce12cd50199b9c5.webp'} />
...
This guide will walk you through how to use vLLM in Masterion:
...
<Steps>
  ...
  ### Step 4: Configure vLLM in Masterion

  - Open the `App Settings` panel in Masterion
...
You're now ready to use vLLM-powered models in Masterion for conversations.
