---
title: Using Upstage in Masterion
description: >-
  Learn how to configure and use Upstage's API Key in Masterion to start
...
This guide will walk you through how to use Upstage within Masterion.
...
<Steps>
  ...
  ### Step 2: Configure Upstage in Masterion
...
And that’s it! You’re now ready to use Upstage’s models for conversations in Masterion.
