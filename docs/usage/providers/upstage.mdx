---
title: Using Upstage in Masterino
description: >-
  Learn how to configure and use Upstage's API Key in Masterino to start
...
This guide will walk you through how to use Upstage within Masterino.
...
<Steps>
  ...
  ### Step 2: Configure Upstage in Masterino
...
And that’s it! You’re now ready to use Upstage’s models for conversations in Masterino.
