---
title: Using DeepSeek API Key in Masterino
description: >-
  Learn how to configure and use the DeepSeek language model in Masterino, obtain
...
# Using DeepSeek in Masterino

<Image alt={'Using DeepSeek in Masterino'} cover src={'/blog/assets34400653/b4d12904-9d5d-46de-bd66-901eeb9c8e52.webp'} />
...
This guide will walk you through how to use DeepSeek in Masterino:
...
<Steps>
  ...
  ### Step 2: Configure DeepSeek in Masterino

  - Go to the `App Settings` page in Masterino
  - Under `AI Providers`, find the `DeepSeek` configuration section

  <Image alt={'Enter DeepSeek API Key in Masterino'} inStep src={'/blog/assets93da89c4892a80e2e5a6caa49d80af5f.webp'} />
...
And that’s it! You’re now ready to start chatting with DeepSeek-powered models in Masterino.
