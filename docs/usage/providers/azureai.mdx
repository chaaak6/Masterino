---
title: Using Azure AI API Key in Masterion
description: >-
  Learn how to configure and use Azure AI models in Masterion, obtain your API
...
# Using Azure AI in Masterion

<Image alt={'Using Azure AI in Masterion'} cover src={'/blog/assets29de82efbe7657a8b9ba7daf0904585d.webp'} />
...
This guide will walk you through how to integrate Azure AI models into Masterion:
...
<Steps>
  ...
  ### Step 3: Configure Azure AI in Masterion
...
That's it! You're now ready to use Azure AI models for conversations in Masterion.
