---
title: Using Azure AI API Key in MasterLion
description: >-
  Learn how to configure and use Azure AI models in MasterLion, obtain your API
...
# Using Azure AI in MasterLion

<Image alt={'Using Azure AI in MasterLion'} cover src={'/blog/assets29de82efbe7657a8b9ba7daf0904585d.webp'} />
...
This guide will walk you through how to integrate Azure AI models into MasterLion:
...
<Steps>
  ...
  ### Step 3: Configure Azure AI in MasterLion
...
That's it! You're now ready to use Azure AI models for conversations in MasterLion.
