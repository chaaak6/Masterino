---
title: Using SenseTime SenseNova in Masterion
description: >-
  Learn how to configure and use your SenseTime SenseNova API Key in Masterion to
...
# Using SenseTime SenseNova in Masterion
...
This guide will walk you through how to use SenseNova within Masterion.
...
<Steps>
  ...
  ### Step 2: Configure SenseNova in Masterion
...
And that’s it! You’re now ready to use SenseTime SenseNova models in Masterion for intelligent conversations.
