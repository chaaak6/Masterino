---
title: Using SenseTime SenseNova in Masterino
description: >-
  Learn how to configure and use your SenseTime SenseNova API Key in Masterino to
...
# Using SenseTime SenseNova in Masterino
...
This guide will walk you through how to use SenseNova within Masterino.
...
<Steps>
  ...
  ### Step 2: Configure SenseNova in Masterino
...
And that’s it! You’re now ready to use SenseTime SenseNova models in Masterino for intelligent conversations.
