---
title: Using SenseTime SenseNova in MasterLion
description: >-
  Learn how to configure and use your SenseTime SenseNova API Key in MasterLion to
...
# Using SenseTime SenseNova in MasterLion
...
This guide will walk you through how to use SenseNova within MasterLion.
...
<Steps>
  ...
  ### Step 2: Configure SenseNova in MasterLion
...
And that’s it! You’re now ready to use SenseTime SenseNova models in MasterLion for intelligent conversations.
