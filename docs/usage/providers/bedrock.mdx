---
title: Using Amazon Bedrock API Key in MasterLion
description: >-
  Learn how to configure and use Amazon Bedrock, a fully managed foundation
  model API service, in MasterLion to start chatting.
tags:
  - Amazon Bedrock
  - Claude 3.5 Sonnet
  - API keys
...
# Using Amazon Bedrock in MasterLion

<Image alt={'Using Amazon Bedrock in MasterLion'} cover src={'/blog/assets34400653/74768b36-28ca-4ec3-a42d-b32abe2c7057.webp'} />
...
This guide will walk you through how to use Amazon Bedrock in MasterLion:
...
<Steps>
  ...
  ### Step 3: Configure Amazon Bedrock in MasterLion

  - Open the `Settings` panel in MasterLion
  - Under `AI Providers`, find and enable the `Amazon Bedrock` option

  <Image alt={'Entering Amazon Bedrock keys in MasterLion'} inStep src={'/blog/assets34400653/7468594b-3355-4cb9-85bc-c9dace137653.webp'} />
...
You’re all set! You can now start chatting in MasterLion using models provided by Amazon Bedrock.
