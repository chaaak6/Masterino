---
title: Using Mistral AI API Key in MasterLion
description: >-
  Learn how to configure and use Mistral AI in MasterLion, including how to obtain
...
# Using Mistral AI in MasterLion

<Image alt={'Using Mistral AI in MasterLion'} cover src={'/blog/assets17870709/a3f9f63a-48f8-4567-b960-7f3636c0d4ed.webp'} />

The Mistral AI API is now publicly available. This guide will walk you through how to use [Mistral AI](https://mistral.ai/) in MasterLion:
...
<Steps>
  ...
  ### Step 2: Configure Mistral AI in MasterLion
...
You're all set! You can now start chatting with models powered by Mistral AI in MasterLion.
