---
title: Using Qiniu Cloud's Large Language Model API Key in Masterion
description: >-
  Learn how to configure and use Qiniu Cloud's large language models in Masterion
...
# Using Qiniu Cloud's Large Language Model in Masterion

<Image alt={'Using Qiniu Cloud LLM in Masterion'} cover src={'/blog/assets48b5c19e20fb870c7bdd34bd3aefbb21.webp'} />
...
This guide will walk you through how to use Qiniu Cloud's large language models in Masterion:
...
<Steps>
  ...
  ### Step 2: Configure Qiniu Cloud LLM Service in Masterion
...
That's it! You're now ready to use Qiniu Cloud's large language models in Masterion for intelligent conversations.
