---
title: Using Qiniu Cloud's Large Language Model API Key in Masterino
description: >-
  Learn how to configure and use Qiniu Cloud's large language models in Masterino
...
# Using Qiniu Cloud's Large Language Model in Masterino

<Image alt={'Using Qiniu Cloud LLM in Masterino'} cover src={'/blog/assets48b5c19e20fb870c7bdd34bd3aefbb21.webp'} />
...
This guide will walk you through how to use Qiniu Cloud's large language models in Masterino:
...
<Steps>
  ...
  ### Step 2: Configure Qiniu Cloud LLM Service in Masterino
...
That's it! You're now ready to use Qiniu Cloud's large language models in Masterino for intelligent conversations.
