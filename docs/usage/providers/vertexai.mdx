---
title: Using Vertex AI API Key in MasterLion
description: >-
  Learn how to configure and use Vertex AI models in MasterLion, obtain your API
...
# Using Vertex AI in MasterLion

<Image alt={'Using Vertex AI in MasterLion'} cover src={'/blog/assets95e6fe7c19ebfb9ead1c5a267aaf2a4e.webp'} />
...
This guide will walk you through how to integrate Vertex AI models into MasterLion:
...
<Steps>
  ...
  ### Step 3: Configure Vertex AI in MasterLion

  - Open MasterLion and go to the App Settings > AI Service Providers section.
...
You're all set! You can now start using Vertex AI models in MasterLion for your conversations.
