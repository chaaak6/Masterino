---
title: Using the Stepfun API Key in Masterino
description: >-
  Learn how to configure and use Stepfun's AI models in Masterino, including how
...
# Using Stepfun in Masterino

<Image alt={'Using Stepfun in Masterino'} cover src={'/blog/assets34400653/95717e2b-1a55-4fca-a96b-b1c186ed4563.webp'} />
...
This guide will walk you through how to use Stepfun in Masterino:
...
<Steps>
  ...
  ### Step 2: Configure Stepfun in Masterino
...
And that’s it! You’re now ready to start chatting with AI models powered by Stepfun in Masterino.
