---
title: Using the SambaNova API Key in Masterino
description: >-
  Learn how to configure and use SambaNova models in Masterino, obtain your API
...
# Using SambaNova in Masterino

<Image alt={'Using SambaNova in Masterino'} cover src={'/blog/assetsd9e6fe2197270f0f774accd6abcf4019.webp'} />
...
This guide will walk you through how to use SambaNova in Masterino:
...
<Steps>
  ...
  ### Step 2: Configure SambaNova in Masterino

  - Go to the `App Settings` section in Masterino
...
You're now ready to start chatting with models powered by SambaNova in Masterino.
