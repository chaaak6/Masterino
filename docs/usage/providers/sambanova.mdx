---
title: Using the SambaNova API Key in Masterion
description: >-
  Learn how to configure and use SambaNova models in Masterion, obtain your API
...
# Using SambaNova in Masterion

<Image alt={'Using SambaNova in Masterion'} cover src={'/blog/assetsd9e6fe2197270f0f774accd6abcf4019.webp'} />
...
This guide will walk you through how to use SambaNova in Masterion:
...
<Steps>
  ...
  ### Step 2: Configure SambaNova in Masterion

  - Go to the `App Settings` section in Masterion
...
You're now ready to start chatting with models powered by SambaNova in Masterion.
