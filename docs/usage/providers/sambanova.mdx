---
title: Using the SambaNova API Key in MasterLion
description: >-
  Learn how to configure and use SambaNova models in MasterLion, obtain your API
...
# Using SambaNova in MasterLion

<Image alt={'Using SambaNova in MasterLion'} cover src={'/blog/assetsd9e6fe2197270f0f774accd6abcf4019.webp'} />
...
This guide will walk you through how to use SambaNova in MasterLion:
...
<Steps>
  ...
  ### Step 2: Configure SambaNova in MasterLion

  - Go to the `App Settings` section in MasterLion
...
You're now ready to start chatting with models powered by SambaNova in MasterLion.
