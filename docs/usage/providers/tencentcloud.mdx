---
title: Using Tencent Cloud API Key in Masterion
description: >-
  Learn how to configure and use Tencent Cloud AI models in Masterion, obtain your
...
# Using Tencent Cloud in Masterion

<Image alt={'Using Tencent Cloud in Masterion'} cover src={'/blog/assetsf625540e8340bafe69ccbb89ad75707a.webp'} />
...
This guide will walk you through how to integrate Tencent Cloud's AI models into Masterion:
...
<Steps>
  ...
  ### Step 2: Configure Tencent Cloud in Masterion

  - Open Masterion and go to App Settings > AI Service Providers.
...
That's it! You’re now ready to use Tencent Cloud’s AI models in Masterion for conversations.
