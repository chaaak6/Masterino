---
title: Using Tencent Cloud API Key in MasterLion
description: >-
  Learn how to configure and use Tencent Cloud AI models in MasterLion, obtain your
...
# Using Tencent Cloud in MasterLion

<Image alt={'Using Tencent Cloud in MasterLion'} cover src={'/blog/assetsf625540e8340bafe69ccbb89ad75707a.webp'} />
...
This guide will walk you through how to integrate Tencent Cloud's AI models into MasterLion:
...
<Steps>
  ...
  ### Step 2: Configure Tencent Cloud in MasterLion

  - Open MasterLion and go to App Settings > AI Service Providers.
...
That's it! You’re now ready to use Tencent Cloud’s AI models in MasterLion for conversations.
