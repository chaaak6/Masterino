---
title: Using Tencent Cloud API Key in Masterino
description: >-
  Learn how to configure and use Tencent Cloud AI models in Masterino, obtain your
...
# Using Tencent Cloud in Masterino

<Image alt={'Using Tencent Cloud in Masterino'} cover src={'/blog/assetsf625540e8340bafe69ccbb89ad75707a.webp'} />
...
This guide will walk you through how to integrate Tencent Cloud's AI models into Masterino:
...
<Steps>
  ...
  ### Step 2: Configure Tencent Cloud in Masterino

  - Open Masterino and go to App Settings > AI Service Providers.
...
That's it! You’re now ready to use Tencent Cloud’s AI models in Masterino for conversations.
