---
title: Using iFLYTEK Spark in MasterLion
description: >-
  Learn how to configure and use the iFLYTEK Spark API Key in MasterLion to start
...
# Using iFLYTEK Spark in MasterLion
...
This guide will walk you through how to use iFLYTEK Spark in MasterLion.
...
<Steps>
  ...
  ### Step 2: Configure iFLYTEK Spark in MasterLion
...
That's it! You're now ready to use iFLYTEK Spark's models for conversations in MasterLion.
