---
title: Using LM Studio in Masterion
description: >-
...
# Using LM Studio in Masterion

<Image alt={'Using LM Studio in Masterion'} cover src={'/blog/assets28749075f0c4d62c1642694a4ed9ec08.webp'} />
...
This guide will walk you through how to use LM Studio within Masterion:
...
<Steps>
  ...
  ### Step 5: Connect LM Studio to Masterion

  - Go to the `App Settings` in Masterion and open the `AI Service Providers` section
...
And that’s it! You’re now ready to use models running in LM Studio directly within Masterion.
