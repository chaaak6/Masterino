---
title: Using InternLM in Masterino
description: >-
  Learn how to configure and use your InternLM API Key in Masterino to start
...
This guide will walk you through how to use InternLM within Masterino.
...
<Steps>
  ...
  ### Step 2: Configure InternLM in Masterino
...
You’re all set! You can now start using InternLM-powered models in Masterino for conversations and interactions.
