---
title: Using InternLM in Masterion
description: >-
  Learn how to configure and use your InternLM API Key in Masterion to start
...
This guide will walk you through how to use InternLM within Masterion.
...
<Steps>
  ...
  ### Step 2: Configure InternLM in Masterion
...
You’re all set! You can now start using InternLM-powered models in Masterion for conversations and interactions.
