---
title: Using InternLM in MasterLion
description: >-
  Learn how to configure and use your InternLM API Key in MasterLion to start
...
This guide will walk you through how to use InternLM within MasterLion.
...
<Steps>
  ...
  ### Step 2: Configure InternLM in MasterLion
...
You’re all set! You can now start using InternLM-powered models in MasterLion for conversations and interactions.
