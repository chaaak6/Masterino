---
title: Using Novita AI API Key in MasterLion
description: >-
  Learn how to integrate Novita AI's large language model API into MasterLion.
  Follow the steps to register a Novita AI account, create an API key, add
  credits, and configure it in MasterLion. Start chatting with a variety of AI
  models.
tags:
  - Novita AI
  - Llama3
...
# Using Novita AI in MasterLion

<Image alt={'Using Novita AI in MasterLion'} cover src={'/blog/assets85af5a2a51b851fe125055d374cc8263.webp'} />
...
This guide will walk you through how to use Novita AI in MasterLion:
...
<Steps>
  ...
  ### Step 3: Configure Novita AI in MasterLion
  ...
  <Image alt={'Enter Novita AI API Key in MasterLion'} inStep src={'/blog/assets05d786345e99f92d11baae5667a04a62.webp'} />
...
That’s it! You’re now ready to chat with Novita AI models directly in MasterLion.
