---
title: Using Wenxin Qianfan in MasterLion
description: >-
  Learn how to configure and use the Wenxin Qianfan API Key in MasterLion to start
...
# Using Wenxin Qianfan in MasterLion
...
This guide will walk you through how to use Wenxin Qianfan in MasterLion.
...
<Steps>
  ...
  ### Step 2: Configure Wenxin Qianfan in MasterLion
...
Now you're all set to start using Wenxin Qianfan models for conversations in MasterLion.
