---
title: Using Tongyi Qianwen API Key in Masterion
description: >-
  Learn how to configure and use Alibaba Cloud's Tongyi Qianwen model in
  Masterion, offering powerful natural language understanding and generation
  capabilities.
tags:
  - Masterion
  - Tongyi Qianwen
...
# Using Tongyi Qianwen in Masterion

<Image alt={'Using Tongyi Qianwen in Masterion'} cover src={'/blog/assets34400653/4e057b43-1e3e-4e96-a948-7cdbff303dcb.webp'} />
...
This guide will walk you through how to use Tongyi Qianwen in Masterion:
...
<Steps>
  ...
  ### Step 3: Configure Tongyi Qianwen in Masterion
...
You’re all set! You can now start using Tongyi Qianwen’s models in Masterion for intelligent conversations.
