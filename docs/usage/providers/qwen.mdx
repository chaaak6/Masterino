---
title: Using Tongyi Qianwen API Key in MasterLion
description: >-
  Learn how to configure and use Alibaba Cloud's Tongyi Qianwen model in
  MasterLion, offering powerful natural language understanding and generation
  capabilities.
tags:
  - MasterLion
  - Tongyi Qianwen
...
# Using Tongyi Qianwen in MasterLion

<Image alt={'Using Tongyi Qianwen in MasterLion'} cover src={'/blog/assets34400653/4e057b43-1e3e-4e96-a948-7cdbff303dcb.webp'} />
...
This guide will walk you through how to use Tongyi Qianwen in MasterLion:
...
<Steps>
  ...
  ### Step 3: Configure Tongyi Qianwen in MasterLion
...
You’re all set! You can now start using Tongyi Qianwen’s models in MasterLion for intelligent conversations.
