---
title: Using Volcengine API Key in Masterion
description: >-
  Learn how to configure and use Volcengine AI models in Masterion, obtain your
...
# Using Volcengine in Masterion

<Image alt={'Using Volcengine in Masterion'} cover src={'/blog/assets80a8b9627374fc345f4bf8e3adf11074.webp'} />
...
This guide will walk you through how to use Volcengine in Masterion:
...
<Steps>
  ...
  ### Step 2: Configure Volcengine in Masterion

  - Open the `App Settings` in Masterion and go to the `AI Service Providers` section
...
You're now ready to start chatting with models powered by Volcengine in Masterion.
