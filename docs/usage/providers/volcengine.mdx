---
title: Using Volcengine API Key in MasterLion
description: >-
  Learn how to configure and use Volcengine AI models in MasterLion, obtain your
...
# Using Volcengine in MasterLion

<Image alt={'Using Volcengine in MasterLion'} cover src={'/blog/assets80a8b9627374fc345f4bf8e3adf11074.webp'} />
...
This guide will walk you through how to use Volcengine in MasterLion:
...
<Steps>
  ...
  ### Step 2: Configure Volcengine in MasterLion

  - Open the `App Settings` in MasterLion and go to the `AI Service Providers` section
...
You're now ready to start chatting with models powered by Volcengine in MasterLion.
