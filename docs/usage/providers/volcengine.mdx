---
title: Using Volcengine API Key in Masterino
description: >-
  Learn how to configure and use Volcengine AI models in Masterino, obtain your
...
# Using Volcengine in Masterino

<Image alt={'Using Volcengine in Masterino'} cover src={'/blog/assets80a8b9627374fc345f4bf8e3adf11074.webp'} />
...
This guide will walk you through how to use Volcengine in Masterino:
...
<Steps>
  ...
  ### Step 2: Configure Volcengine in Masterino

  - Open the `App Settings` in Masterino and go to the `AI Service Providers` section
...
You're now ready to start chatting with models powered by Volcengine in Masterino.
