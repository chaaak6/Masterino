---
title: 在 Masterion 中使用 Vercel AI Gateway
description: 了解如何在 Masterion 中集成和使用 Vercel AI Gateway 的统一 API
tags:
  - Masterion
  - Vercel AI Gateway
  - API 密钥
...
<Steps>
  ...
  ### 第二步：在 Masterion 中配置 Vercel AI Gateway

  - 进入 Masterion 的 `设置` 页面
...
至此，您可以在 Masterion 中使用 Vercel AI Gateway 提供的模型开始聊天了。
