---
title: Using PPIO API Key in MasterLion
description: >-
  Learn how to integrate PPIO's LLM API into MasterLion. Follow these steps to
  register a PPIO account, create an API key, and configure it in MasterLion.
tags:
  - PPIO
  - PPInfra
  - DeepSeek
...
# Using PPIO in MasterLion

<Image alt={'Using PPIO in MasterLion'} cover src={'/blog/assets06d4e543cbaca9a2762923a23b2cae67.webp'} />
...
This guide will walk you through how to use PPIO in MasterLion:
...
<Steps>
  ...
  ### Step 3: Configure PPIO in MasterLion
  ...
  <Image alt={'Enter PPIO API Key in MasterLion'} inStep src={'/blog/assetsbfe7d519c29884b6699e89866e1db7e2.webp'} />
...
That's it! You're now ready to use PPIO's models for conversations in MasterLion.
