---
title: Using PPIO API Key in Masterion
description: >-
  Learn how to integrate PPIO's LLM API into Masterion. Follow these steps to
  register a PPIO account, create an API key, and configure it in Masterion.
tags:
  - PPIO
  - PPInfra
  - DeepSeek
...
# Using PPIO in Masterion

<Image alt={'Using PPIO in Masterion'} cover src={'/blog/assets06d4e543cbaca9a2762923a23b2cae67.webp'} />
...
This guide will walk you through how to use PPIO in Masterion:
...
<Steps>
  ...
  ### Step 3: Configure PPIO in Masterion
  ...
  <Image alt={'Enter PPIO API Key in Masterion'} inStep src={'/blog/assetsbfe7d519c29884b6699e89866e1db7e2.webp'} />
...
That's it! You're now ready to use PPIO's models for conversations in Masterion.
