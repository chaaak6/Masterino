---
title: Using Infini-AI in Masterion
description: >-
  Learn how to configure and use Infini-AI's API Key in Masterion to enable
...
This guide will walk you through the steps to quickly integrate Infini-AI's capabilities into Masterion.
...
<Steps>
  ...
  ### Step 2: Configure the Model Service in Masterion

  - Open Masterion and go to the "Settings" page
