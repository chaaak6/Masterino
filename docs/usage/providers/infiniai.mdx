---
title: Using Infini-AI in MasterLion
description: >-
  Learn how to configure and use Infini-AI's API Key in MasterLion to enable
...
This guide will walk you through the steps to quickly integrate Infini-AI's capabilities into MasterLion.
...
<Steps>
  ...
  ### Step 2: Configure the Model Service in MasterLion

  - Open MasterLion and go to the "Settings" page
