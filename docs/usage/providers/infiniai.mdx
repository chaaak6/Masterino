---
title: Using Infini-AI in Masterino
description: >-
  Learn how to configure and use Infini-AI's API Key in Masterino to enable
...
This guide will walk you through the steps to quickly integrate Infini-AI's capabilities into Masterino.
...
<Steps>
  ...
  ### Step 2: Configure the Model Service in Masterino

  - Open Masterino and go to the "Settings" page
