---
title: 帮助与支持
description: 获取 MasterLion 帮助——常用指南、社区支持、问题反馈及联系方式。
tags:
  - MasterLion
  - 帮助
  - 支持
...
- [获取 MasterLion](/zh/docs/usage/getting-started/get-lobehub) — 浏览器、桌面端或移动端
...
| **Reddit**        | 讨论与社区动态      | [r/MasterLion](https://www.reddit.com/r/MasterLion/)                   |
| **GitHub Issues** | Bug 反馈、功能建议  | [提交 Issue](https://github.com/lobehub/lobehub/issues/new/choose) |
| **邮箱**            | 合作、企业咨询      | [support@bielcrystal.com](mailto:support@bielcrystal.com)                          |
