---
title: MasterLion Model Service Providers - Environment Variables and Configuration
description: >-
...
When deploying MasterLion, a rich set of environment variables related to model service providers is provided, allowing you to easily define the model service providers to be enabled in MasterLion.
...
- [Why is the return value blank after installing Docker, configuring environment variables?](https://github.com/biel-cc/MasterLion/discussions/623)
- [Reasons for errors when using third-party interfaces](https://github.com/biel-cc/MasterLion/discussions/734)
- [No response in chat after filling in the proxy server address](https://github.com/biel-cc/MasterLion/discussions/1065)
...
You can find all current model names in [modelProviders](https://github.com/biel-cc/MasterLion/tree/main/src/config/modelProviders).
