---
title: Masterion Authentication Service Configuration
description: >-
...
Masterion supports the configuration of external authentication services using Better Auth for internal use within enterprises/organizations to centrally manage user authorization.
...
To enable Better Auth in Masterion, set the following environment variables:
...
Allow Masterion to receive notifications when user information is updated in the identity provider. Supported providers include Casdoor and Logto. Please refer to the specific provider documentation for configuration details.
