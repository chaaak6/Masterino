---
title: Masterino Authentication Service Configuration
description: >-
...
Masterino supports the configuration of external authentication services using Better Auth for internal use within enterprises/organizations to centrally manage user authorization.
...
To enable Better Auth in Masterino, set the following environment variables:
...
Allow Masterino to receive notifications when user information is updated in the identity provider. Supported providers include Casdoor and Logto. Please refer to the specific provider documentation for configuration details.
