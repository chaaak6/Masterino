---
title: Build Your Own Masterion - Choose Your Deployment Platform
description: >-
  Explore multiple deployment platforms like Vercel, Docker, Docker Compose, and
  more to deploy Masterion. Choose the platform that best suits your needs.
tags:
  - Masterion
  - Deployment Platform
  - Vercel
...
# Build Your Own Masterion

Masterion can be self-hosted on your own infrastructure, giving you complete control over your data, customization, and deployment environment. Whether you're deploying for a team, organization, or personal use, Masterion supports multiple deployment methods.

<PlatformCards urlPrefix={'platform'} />

## Architecture Overview

Masterion consists of several key components:
...
Before deploying Masterion, gather the following:
...
5. **Regular updates** — Keep Masterion and dependencies up to date
