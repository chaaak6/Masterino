---
title: Build Your Own MasterLion - Choose Your Deployment Platform
description: >-
  Explore multiple deployment platforms like Vercel, Docker, Docker Compose, and
  more to deploy MasterLion. Choose the platform that best suits your needs.
tags:
  - MasterLion
  - Deployment Platform
  - Vercel
...
# Build Your Own MasterLion

MasterLion can be self-hosted on your own infrastructure, giving you complete control over your data, customization, and deployment environment. Whether you're deploying for a team, organization, or personal use, MasterLion supports multiple deployment methods.

<PlatformCards urlPrefix={'platform'} />

## Architecture Overview

MasterLion consists of several key components:
...
Before deploying MasterLion, gather the following:
...
5. **Regular updates** — Keep MasterLion and dependencies up to date
