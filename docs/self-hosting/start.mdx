---
title: Build Your Own Masterino - Choose Your Deployment Platform
description: >-
  Explore multiple deployment platforms like Vercel, Docker, Docker Compose, and
  more to deploy Masterino. Choose the platform that best suits your needs.
tags:
  - Masterino
  - Deployment Platform
  - Vercel
...
# Build Your Own Masterino

Masterino can be self-hosted on your own infrastructure, giving you complete control over your data, customization, and deployment environment. Whether you're deploying for a team, organization, or personal use, Masterino supports multiple deployment methods.

<PlatformCards urlPrefix={'platform'} />

## Architecture Overview

Masterino consists of several key components:
...
Before deploying Masterino, gather the following:
...
5. **Regular updates** — Keep Masterino and dependencies up to date
