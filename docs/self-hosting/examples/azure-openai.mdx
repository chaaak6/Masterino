---
title: Configuring Azure OpenAI for MasterLion
description: >-
  Learn how to configure Azure OpenAI for MasterLion, including interface
...
MasterLion supports using [Azure OpenAI](https://learn.microsoft.com/zh-cn/azure/ai-services/openai/concepts/models) as the model service provider for OpenAI. This article will explain how to configure Azure OpenAI.
