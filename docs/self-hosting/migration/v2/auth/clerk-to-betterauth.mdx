...
description: >-
  Guide for migrating your MasterLion deployment from Clerk authentication to
...
This guide helps you migrate your existing Clerk-based MasterLion deployment to Better Auth.
...
<Callout type={'error'}>
  **Important Notice**:
  ...
  - If you have any questions, feel free to ask in our [Discord](https://discord.com/invite/AYFPHvv2jT) community or [GitHub Issue](https://github.com/biel-cc/MasterLion/issues/11707)
</Callout>
...
4. **Notify Users**
   ...
   ![MasterLion Login Page - Social Login Hint](https://hub-apac-1.lobeobjects.space/docs/8d0563701fcd17ad7252a72b1746dd42.png)
