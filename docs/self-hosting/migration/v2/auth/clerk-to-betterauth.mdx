...
description: >-
  Guide for migrating your Masterion deployment from Clerk authentication to
...
This guide helps you migrate your existing Clerk-based Masterion deployment to Better Auth.
...
4. **Notify Users**
   ...
   ![Masterion Login Page - Social Login Hint](https://hub-apac-1.lobeobjects.space/docs/8d0563701fcd17ad7252a72b1746dd42.png)
