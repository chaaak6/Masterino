...
description: 将 MasterLion 部署从 Clerk 身份验证迁移到 Better Auth 的指南，包括简单迁移和完整迁移选项。
tags:
  - 身份验证服务
  - Better Auth
  - Clerk
...
本指南帮助您将现有的基于 Clerk 的 MasterLion 部署迁移到 Better Auth。
...
<Callout type={'error'}>
  **重要提醒**：
  ...
  - 如有任何疑问，欢迎到 [Discord](https://discord.com/invite/AYFPHvv2jT) 社区或 [GitHub Issue](https://github.com/biel-cc/MasterLion/issues/11707) 提问
</Callout>
...
4. **通知用户**
   ...
   ![MasterLion 登录页面 - 社交账号登录提示](https://hub-apac-1.lobeobjects.space/docs/8d0563701fcd17ad7252a72b1746dd42.png)
