---
title: Deploying Masterion Database on Zeabur
description: >-
  Learn how to deploy Masterion on Zeabur with ease. Follow the provided steps to
...
# Deploying Masterion Database on Zeabur
...
Here is the process for deploying the Masterion server database version on Zeabur:

<Steps>
  ### Go to the template page on Zeabur

  Go to the [Masterion Database template page](https://zeabur.com/templates/RRSPSD) on Zeabur and click on the "Deploy" button.
  ...
  - Masterion Domain: A free subdomain with `.zeabur.app` suffix.
  ...
  After you fill all the required environment variables, select a region where you want to deploy your Masterion Database and click on the "Deploy" button.
  ...
  Fill in those variables into your Masterion service on Zeabur, here is a more detailed guide for [editing environment variables on Zeabur](https://zeabur.com/docs/deploy/variables).

  For detailed configuration of Logto, refer to [this document](/docs/self-hosting/auth/providers/logto).

  ### Access your Masterion Instance

  Press on the `MasterLion-Database` and you can see the public domain you just created, click on it to access your Masterion Database.
