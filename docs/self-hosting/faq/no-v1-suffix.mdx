---
title: Troubleshooting `OPENAI_PROXY_URL` in MasterLion Configuration for Empty Response
description: >-
  Learn how to troubleshoot and resolve the issue of receiving an empty response
  after configuring the MasterLion `OPENAI_PROXY_URL` environment variable.
tags:
  - OPENAI_PROXY_URL
...
- [Why is the return value blank after configuring environment variables in Docker?](https://github.com/biel-cc/MasterLion/discussions/623)
- [Reasons for errors when using third-party interfaces](https://github.com/biel-cc/MasterLion/discussions/734)
- [No response when the proxy server address is filled in for chat](https://github.com/biel-cc/MasterLion/discussions/1065)
