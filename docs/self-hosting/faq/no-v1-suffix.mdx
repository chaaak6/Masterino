---
title: Troubleshooting `OPENAI_PROXY_URL` in Masterino Configuration for Empty Response
description: >-
  Learn how to troubleshoot and resolve the issue of receiving an empty response
  after configuring the Masterino `OPENAI_PROXY_URL` environment variable.
tags:
  - OPENAI_PROXY_URL
