---
title: Troubleshooting `OPENAI_PROXY_URL` in Masterion Configuration for Empty Response
description: >-
  Learn how to troubleshoot and resolve the issue of receiving an empty response
  after configuring the Masterion `OPENAI_PROXY_URL` environment variable.
tags:
  - OPENAI_PROXY_URL
