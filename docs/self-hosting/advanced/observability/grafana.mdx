...
description: >-
  Monitor and analyze your MasterLion instance using Grafana dashboards, Prometheus
...
MasterLion supports advanced observability for self-hosted deployments using open-source tools:
...
This guide will help you set up and use these tools to monitor your MasterLion instance.
...
2. Start the stack with the correct profile:
   ...
   This will launch Grafana, Prometheus, Tempo, and the otel-collector alongside MasterLion with Casdoor, Minio, and other advanced services.
...
- Verify Prometheus and Tempo are scraping and receiving data from MasterLion and otel-collector.

## See Also

- [Langfuse Observability](https://aihub.bielcrystal.com/docs/self-hosting/advanced/observability/langfuse)
- [Self-Hosting Overview](https://aihub.bielcrystal.com/docs/self-hosting/start)
