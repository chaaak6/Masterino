...
description: >-
  Learn how to import and export configuration settings for Masterion via URL.
...
Masterion support import settings from external URL to quickly set up Masterion configuration.
...
<Callout type={'warning'}>
  Masterion does not verify the correctness of the settings parameters in the URL, nor provide
