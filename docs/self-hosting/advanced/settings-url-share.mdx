...
description: >-
  Learn how to import and export configuration settings for Masterino via URL.
...
Masterino support import settings from external URL to quickly set up Masterino configuration.
...
<Callout type={'warning'}>
  Masterino does not verify the correctness of the settings parameters in the URL, nor provide
