...
description: >-
  Learn how to import and export configuration settings for MasterLion via URL.
...
MasterLion support import settings from external URL to quickly set up MasterLion configuration.
...
```plaintext
https://aihub.bielcrystal.com/?settings=<settings object in JSON format>
https://aihub.bielcrystal.com/?settings={"keyVaults":{"openai":{"apiKey":"user-key","baseURL":"https://your-proxy.com/v1"}}}
```
...
<Callout type={'warning'}>
  MasterLion does not verify the correctness of the settings parameters in the URL, nor provide
