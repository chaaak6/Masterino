...
title: >-
  ...
  Information
description: >-
  Learn how to configure the SearXNG online search functionality for MasterLion,
...
When enabled, MasterLion replaces the Jina endpoints as follows:
...
You can find publicly available SearXNG instances in the [SearXNG instance list](https://searx.space/). Choose an instance that is fast and reliable, and then configure its URL in MasterLion.
...
1. Restart the MasterLion service.
...
- [MasterLion Online Search RFC Discussion](https://github.com/biel-cc/MasterLion/discussions/6447)
