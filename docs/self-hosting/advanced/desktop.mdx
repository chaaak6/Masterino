---
title: Automatic Synchronization with MasterLion Desktop
description: Configure MasterLion Desktop for a synchronized experience
tags:
  - MasterLion
...
# Automatic Synchronization with MasterLion Desktop

MasterLion Desktop provides users with an enhanced experience while also expanding the capabilities of MasterLion, allowing users to utilize MasterLion in offline environments. This document will guide you on how to configure MasterLion Desktop and connect it to your self-hosted instance.

## System Requirements

MasterLion Desktop is built using Electron and supports the following operating systems:
...
The version release of MasterLion Desktop follows this logic:

- **Beta Version**: All merges to the main branch that are automatically released will be created as Beta versions of MasterLion Desktop.
...
MasterLion Desktop can connect to your self-hosted MasterLion instance, allowing you to use your self-hosted configuration on the desktop.
...
If you are deploying MasterLion using one-click deployment methods (such as Vercel, Railway, etc.), you need to:
...
1. Open MasterLion Desktop.
2. Click the Wi-Fi icon in the upper right corner.
3. Enter the address of your self-hosted instance (e.g., `https://your-MasterLion-instance.com`).
...
- Example file names:
  - Apple Silicon: `MasterLion-Beta-1.83.6-arm64.dmg` or `MasterLion-Beta-1.83.6-arm64-mac.zip`
  - Intel: `MasterLion-Beta-1.83.6-x64.dmg` or `MasterLion-Beta-1.83.6-mac.zip`
