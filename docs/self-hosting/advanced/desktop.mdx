---
title: Automatic Synchronization with Masterion Desktop
description: Configure Masterion Desktop for a synchronized experience
tags:
  - Masterion
...
# Automatic Synchronization with Masterion Desktop

Masterion Desktop provides users with an enhanced experience while also expanding the capabilities of Masterion, allowing users to utilize Masterion in offline environments. This document will guide you on how to configure Masterion Desktop and connect it to your self-hosted instance.

## System Requirements

Masterion Desktop is built using Electron and supports the following operating systems:
...
The version release of Masterion Desktop follows this logic:

- **Beta Version**: All merges to the main branch that are automatically released will be created as Beta versions of Masterion Desktop.
...
Masterion Desktop can connect to your self-hosted Masterion instance, allowing you to use your self-hosted configuration on the desktop.
...
If you are deploying Masterion using one-click deployment methods (such as Vercel, Railway, etc.), you need to:
