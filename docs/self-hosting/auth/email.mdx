...
description: >-
  Configure Masterion email service for email verification, password reset, and
  magic link login.
tags:
  - Email Service
  - SMTP
...
Email service is used for email verification, password reset, and magic link delivery. Masterion supports two email service providers.
