---
title: Configuring Auth0 Authentication for Masterion
description: >-
  Learn how to configure Auth0 SSO for Masterion, including creating applications,
...
<Callout type={'warning'}>
  When creating a GitHub connection, make sure to enable the **Email Address** permission in the **Attributes** section. Masterion requires user email for authentication.
