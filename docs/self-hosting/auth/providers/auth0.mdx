---
title: Configuring Auth0 Authentication for Masterino
description: >-
  Learn how to configure Auth0 SSO for Masterino, including creating applications,
...
<Callout type={'warning'}>
  When creating a GitHub connection, make sure to enable the **Email Address** permission in the **Attributes** section. Masterino requires user email for authentication.
