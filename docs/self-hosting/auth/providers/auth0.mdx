---
title: Configuring Auth0 Authentication for MasterLion
description: >-
  Learn how to configure Auth0 SSO for MasterLion, including creating applications,
...
<Callout type={'warning'}>
  When creating a GitHub connection, make sure to enable the **Email Address** permission in the **Attributes** section. MasterLion requires user email for authentication.
