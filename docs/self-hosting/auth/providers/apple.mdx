---
title: Configuring Apple Authentication for MasterLion
description: >-
  Learn how to configure Apple Sign In for MasterLion, including creating
...
<Steps>
  ...
  3. Fill in:
     - **Description**: e.g., `MasterLion Web`
