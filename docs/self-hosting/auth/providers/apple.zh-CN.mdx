---
title: 在 Masterino 中配置 Apple 身份验证
description: 学习如何在 Masterino 中配置 Apple 登录，包括在 Apple Developer Portal 创建凭证和设置环境变量。
tags:
  - Apple
  - 身份验证
  - Masterino
...
<Callout type={'info'}>
  部署成功后，用户将可以通过 Apple 身份认证并使用 Masterino。
</Callout>
