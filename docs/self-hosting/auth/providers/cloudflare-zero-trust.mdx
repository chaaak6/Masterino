---
title: Configuring Cloudflare Zero Trust Authentication for Masterion
description: >-
  Learn how to configure Cloudflare Zero Trust SSO for Masterion, including
...
<Steps>
  ...
  | `AUTH_SSO_PROVIDERS`                | Required | SSO provider for Masterion. Use `cloudflare-zero-trust`                         |
...
<Callout type={'info'}>
  After successful deployment, users will be able to authenticate with Cloudflare Zero Trust and use Masterion.
</Callout>
