---
title: Configuring Cloudflare Zero Trust Authentication for MasterLion
description: >-
  Learn how to configure Cloudflare Zero Trust SSO for MasterLion, including
...
<Steps>
  ...
  | `AUTH_SSO_PROVIDERS`                | Required | SSO provider for MasterLion. Use `cloudflare-zero-trust`                         |
...
<Callout type={'info'}>
  After successful deployment, users will be able to authenticate with Cloudflare Zero Trust and use MasterLion.
</Callout>
