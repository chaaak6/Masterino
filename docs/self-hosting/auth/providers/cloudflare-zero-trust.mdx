---
title: Configuring Cloudflare Zero Trust Authentication for Masterino
description: >-
  Learn how to configure Cloudflare Zero Trust SSO for Masterino, including
...
<Steps>
  ...
  | `AUTH_SSO_PROVIDERS`                | Required | SSO provider for Masterino. Use `cloudflare-zero-trust`                         |
...
<Callout type={'info'}>
  After successful deployment, users will be able to authenticate with Cloudflare Zero Trust and use Masterino.
</Callout>
