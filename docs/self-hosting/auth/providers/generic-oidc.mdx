---
title: Configuring Generic OIDC Authentication for MasterLion
description: >-
  Learn how to configure any OpenID Connect provider for MasterLion using Generic
  OIDC integration.
tags:
  - Generic OIDC
  - OpenID Connect
...
Use Generic OIDC to integrate MasterLion with any OpenID Connect compliant identity provider not explicitly listed in our supported providers.
