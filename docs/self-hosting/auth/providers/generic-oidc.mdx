---
title: Configuring Generic OIDC Authentication for Masterion
description: >-
  Learn how to configure any OpenID Connect provider for Masterion using Generic
  OIDC integration.
tags:
  - Generic OIDC
  - OpenID Connect
...
Use Generic OIDC to integrate Masterion with any OpenID Connect compliant identity provider not explicitly listed in our supported providers.
