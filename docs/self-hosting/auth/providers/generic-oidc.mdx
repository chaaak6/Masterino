---
title: Configuring Generic OIDC Authentication for Masterino
description: >-
  Learn how to configure any OpenID Connect provider for Masterino using Generic
  OIDC integration.
tags:
  - Generic OIDC
  - OpenID Connect
...
Use Generic OIDC to integrate Masterino with any OpenID Connect compliant identity provider not explicitly listed in our supported providers.
