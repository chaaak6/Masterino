---
title: Configuring Logto Authentication for Masterino
description: >-
  Learn how to configure Logto SSO for Masterino, including creating an
...
<Steps>
  ...
  4. Fill in the application name: `Masterino`
  ...
  | `AUTH_SSO_PROVIDERS`        | Required | SSO provider for Masterino. Use `logto` for Logto                               |
  ...
  Configure Logto [Webhook](https://docs.logto.io/developers/webhooks/configure-webhooks) to sync user data updates to Masterino.
...
<Callout type={'info'}>
  After successful deployment, users will be able to authenticate with Logto and use Masterino.
</Callout>
