---
title: Configuring Logto Authentication for Masterion
description: >-
  Learn how to configure Logto SSO for Masterion, including creating an
...
<Steps>
  ...
  4. Fill in the application name: `Masterion`
  ...
  | `AUTH_SSO_PROVIDERS`        | Required | SSO provider for Masterion. Use `logto` for Logto                               |
  ...
  Configure Logto [Webhook](https://docs.logto.io/developers/webhooks/configure-webhooks) to sync user data updates to Masterion.
...
<Callout type={'info'}>
  After successful deployment, users will be able to authenticate with Logto and use Masterion.
</Callout>
