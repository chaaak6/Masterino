---
title: Configuring Logto Authentication for MasterLion
description: >-
  Learn how to configure Logto SSO for MasterLion, including creating an
...
<Steps>
  ...
  4. Fill in the application name: `MasterLion`
  ...
  | `AUTH_SSO_PROVIDERS`        | Required | SSO provider for MasterLion. Use `logto` for Logto                               |
  ...
  Configure Logto [Webhook](https://docs.logto.io/developers/webhooks/configure-webhooks) to sync user data updates to MasterLion.
...
<Callout type={'info'}>
  After successful deployment, users will be able to authenticate with Logto and use MasterLion.
</Callout>
