---
title: Configuring ZITADEL Authentication for Masterion
description: >-
  Learn how to configure ZITADEL SSO for Masterion, including creating an
...
<Steps>
  ...
  | `AUTH_SSO_PROVIDERS`  | Required | SSO provider for Masterion. Use `zitadel` for ZITADEL                           |
...
<Callout type={'info'}>
  After successful deployment, users will be able to authenticate with ZITADEL and use Masterion.
</Callout>
