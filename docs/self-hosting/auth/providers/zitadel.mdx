---
title: Configuring ZITADEL Authentication for MasterLion
description: >-
  Learn how to configure ZITADEL SSO for MasterLion, including creating an
...
<Steps>
  ...
  | `AUTH_SSO_PROVIDERS`  | Required | SSO provider for MasterLion. Use `zitadel` for ZITADEL                           |
...
<Callout type={'info'}>
  After successful deployment, users will be able to authenticate with ZITADEL and use MasterLion.
</Callout>
