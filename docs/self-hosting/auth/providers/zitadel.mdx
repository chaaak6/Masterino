---
title: Configuring ZITADEL Authentication for Masterino
description: >-
  Learn how to configure ZITADEL SSO for Masterino, including creating an
...
<Steps>
  ...
  | `AUTH_SSO_PROVIDERS`  | Required | SSO provider for Masterino. Use `zitadel` for ZITADEL                           |
...
<Callout type={'info'}>
  After successful deployment, users will be able to authenticate with ZITADEL and use Masterino.
</Callout>
