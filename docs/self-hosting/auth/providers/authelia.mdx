---
title: Configuring Authelia Authentication for MasterLion
description: >-
  Learn how to configure Authelia SSO for MasterLion, including setting up OIDC
...
<Steps>
  ...
  | `AUTH_SSO_PROVIDERS`   | Required | SSO provider for MasterLion. Use `authelia` for Authelia                         |
...
<Callout type={'info'}>
  After successful deployment, users will be able to authenticate with Authelia and use MasterLion.
</Callout>
