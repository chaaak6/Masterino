---
title: Configuring Authelia Authentication for Masterion
description: >-
  Learn how to configure Authelia SSO for Masterion, including setting up OIDC
...
<Steps>
  ...
  | `AUTH_SSO_PROVIDERS`   | Required | SSO provider for Masterion. Use `authelia` for Authelia                         |
...
<Callout type={'info'}>
  After successful deployment, users will be able to authenticate with Authelia and use Masterion.
</Callout>
