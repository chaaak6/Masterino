---
title: Configuring Authelia Authentication for Masterino
description: >-
  Learn how to configure Authelia SSO for Masterino, including setting up OIDC
...
<Steps>
  ...
  | `AUTH_SSO_PROVIDERS`   | Required | SSO provider for Masterino. Use `authelia` for Authelia                         |
...
<Callout type={'info'}>
  After successful deployment, users will be able to authenticate with Authelia and use Masterino.
</Callout>
