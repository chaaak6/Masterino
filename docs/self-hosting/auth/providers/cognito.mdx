---
title: Configuring AWS Cognito Authentication for MasterLion
description: >-
  Learn how to configure AWS Cognito SSO for MasterLion, including creating a User
