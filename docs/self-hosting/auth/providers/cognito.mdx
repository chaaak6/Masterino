---
title: Configuring AWS Cognito Authentication for Masterion
description: >-
  Learn how to configure AWS Cognito SSO for Masterion, including creating a User
