---
title: Configuring AWS Cognito Authentication for Masterino
description: >-
  Learn how to configure AWS Cognito SSO for Masterino, including creating a User
