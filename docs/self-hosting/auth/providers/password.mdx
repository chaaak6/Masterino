---
title: Configuring Email/Password Authentication for Masterion
description: >-
  Learn how to configure email and password authentication for Masterion,
...
Masterion supports traditional email and password authentication out of the box.
