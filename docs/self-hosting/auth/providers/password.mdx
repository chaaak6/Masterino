---
title: Configuring Email/Password Authentication for MasterLion
description: >-
  Learn how to configure email and password authentication for MasterLion,
...
MasterLion supports traditional email and password authentication out of the box.
