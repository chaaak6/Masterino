---
title: Configuring Authentik Authentication for Masterion
description: >-
  Learn how to configure Authentik SSO for Masterion, including creating an OAuth2
...
<Steps>
  ...
  | `AUTH_SSO_PROVIDERS`    | Required | SSO provider for Masterion. Use `authentik` for Authentik                       |
...
<Callout type={'info'}>
  After successful deployment, users will be able to authenticate with Authentik and use Masterion.
</Callout>
