---
title: Configuring Authentik Authentication for Masterino
description: >-
  Learn how to configure Authentik SSO for Masterino, including creating an OAuth2
...
<Steps>
  ...
  | `AUTH_SSO_PROVIDERS`    | Required | SSO provider for Masterino. Use `authentik` for Authentik                       |
...
<Callout type={'info'}>
  After successful deployment, users will be able to authenticate with Authentik and use Masterino.
</Callout>
