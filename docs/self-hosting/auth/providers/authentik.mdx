---
title: Configuring Authentik Authentication for MasterLion
description: >-
  Learn how to configure Authentik SSO for MasterLion, including creating an OAuth2
...
<Steps>
  ...
  | `AUTH_SSO_PROVIDERS`    | Required | SSO provider for MasterLion. Use `authentik` for Authentik                       |
...
<Callout type={'info'}>
  After successful deployment, users will be able to authenticate with Authentik and use MasterLion.
</Callout>
