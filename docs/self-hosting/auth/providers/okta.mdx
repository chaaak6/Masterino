---
title: Configuring Okta Authentication for MasterLion
description: >-
  Learn how to configure Okta SSO for MasterLion, including creating an application
...
<Steps>
  ...
  5. Configure the application:
     - App integration name: `MasterLion`
  ...
  | `AUTH_SSO_PROVIDERS` | Required | SSO provider for MasterLion. Use `okta` for Okta                                 |
...
<Callout type={'info'}>
  After successful deployment, users will be able to authenticate with Okta and use MasterLion.
</Callout>
