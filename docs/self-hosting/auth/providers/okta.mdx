---
title: Configuring Okta Authentication for Masterino
description: >-
  Learn how to configure Okta SSO for Masterino, including creating an application
...
<Steps>
  ...
  5. Configure the application:
     - App integration name: `Masterino`
  ...
  | `AUTH_SSO_PROVIDERS` | Required | SSO provider for Masterino. Use `okta` for Okta                                 |
...
<Callout type={'info'}>
  After successful deployment, users will be able to authenticate with Okta and use Masterino.
</Callout>
