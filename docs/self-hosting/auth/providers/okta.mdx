---
title: Configuring Okta Authentication for Masterion
description: >-
  Learn how to configure Okta SSO for Masterion, including creating an application
...
<Steps>
  ...
  5. Configure the application:
     - App integration name: `Masterion`
  ...
  | `AUTH_SSO_PROVIDERS` | Required | SSO provider for Masterion. Use `okta` for Okta                                 |
...
<Callout type={'info'}>
  After successful deployment, users will be able to authenticate with Okta and use Masterion.
</Callout>
