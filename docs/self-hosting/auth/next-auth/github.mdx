---
title: Configuring Github Authentication Service for Masterino
description: >-
  Learn how to configure Github authentication service for Masterino, including
...
<Steps>
  ...
  | `NEXT_AUTH_SSO_PROVIDERS` | Required | Select the Single Sign-On provider for Masterino. Use `github` for Github.                                                                                                                              |
...
<Callout type={'info'}>
  After successful deployment, users will be able to authenticate with Github and use Masterino.
</Callout>
