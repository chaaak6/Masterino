---
title: Configuring Github Authentication Service for MasterLion
description: >-
  Learn how to configure Github authentication service for MasterLion, including
...
<Steps>
  ...
  | `NEXT_AUTH_SSO_PROVIDERS` | Required | Select the Single Sign-On provider for MasterLion. Use `github` for Github.                                                                                                                              |
...
<Callout type={'info'}>
  After successful deployment, users will be able to authenticate with Github and use MasterLion.
</Callout>
