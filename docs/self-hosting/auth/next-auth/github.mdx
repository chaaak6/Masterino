---
title: Configuring Github Authentication Service for Masterion
description: >-
  Learn how to configure Github authentication service for Masterion, including
...
<Steps>
  ...
  | `NEXT_AUTH_SSO_PROVIDERS` | Required | Select the Single Sign-On provider for Masterion. Use `github` for Github.                                                                                                                              |
...
<Callout type={'info'}>
  After successful deployment, users will be able to authenticate with Github and use Masterion.
</Callout>
