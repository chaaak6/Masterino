---
title: Configure ZITADEL Authentication Service for Masterino
description: >-
  Learn how to configure ZITADEL Authentication Service for Masterino deployment,
  including creating ZITADEL applications, setting up environment variables, and
  enabling single sign-on (SSO).
tags:
  - ZITADEL Authentication
  - Masterino Deployment
  - Single Sign-On (SSO)
...
<Steps>
  ...
  <Callout type={'important'}>
    ...
    - Replace `http(s)://your-domain` with the actual URL that Masterino is deployed to.
  </Callout>
...
<Callout>
  After successful deployment, users will be able to authenticate and use Masterino using existing
