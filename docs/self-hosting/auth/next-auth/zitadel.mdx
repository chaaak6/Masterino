---
title: Configure ZITADEL Authentication Service for MasterLion
description: >-
  Learn how to configure ZITADEL Authentication Service for MasterLion deployment,
  including creating ZITADEL applications, setting up environment variables, and
  enabling single sign-on (SSO).
tags:
  - ZITADEL Authentication
  - MasterLion Deployment
  - Single Sign-On (SSO)
...
<Steps>
  ...
  <Callout type={'important'}>
    ...
    - Replace `http(s)://your-domain` with the actual URL that MasterLion is deployed to.
  </Callout>
...
<Callout>
  After successful deployment, users will be able to authenticate and use MasterLion using existing
