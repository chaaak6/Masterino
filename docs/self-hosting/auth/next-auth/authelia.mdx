---
title: Configuring Authelia Authentication Service for Masterino
description: >-
  Learn how to configure Authelia authentication service in Masterino, including
  creating a provider, configuring environment variables, and deploying Masterino.
...
<Steps>
  ...
  Make sure to replace secret and `redirect_urls` with your own values. Note! The secret configured in Authelia is ciphertext, i.e., a salted hash value. Its corresponding plaintext needs to be filled in Masterino later.
