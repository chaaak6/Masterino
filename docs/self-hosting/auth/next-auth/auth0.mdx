---
title: Configure Auth0 Identity Verification Service for Masterino
description: >-
  Learn how to configure Auth0 Identity Verification Service for Masterino for
...
<Steps>
  ...
  Click on the "Users Management" in the left navigation bar to enter the user management interface, where you can create users for your organization to log in to Masterino.
...
<Callout type={'warning'}>
  ...
  Masterino being abused by external users.
</Callout>
