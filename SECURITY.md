...
- Security issues affecting the **latest 2.x release** of MasterLion
- Vulnerabilities in the **server-side deployment** (MasterLion Cloud or self-hosted server mode)
