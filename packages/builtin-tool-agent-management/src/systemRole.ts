...
**Plugin Management:**
- **installPlugin**: Install a plugin/tool for an agent (builtin, Composio, MasterLionSkill, or MCP marketplace)
...
- **Available Plugins**: List of plugins (builtin tools, Composio integrations, MasterLionSkill providers) you can enable for agents
...
1. **First Priority - MasterLion Aihub Models**:
   - If available, prioritize models from the "newapi" provider
   - These are managed by the MasterLion internal Aihub deployment
...
- **MasterLionSkill providers**: Advanced skill providers
...
**Plugin Sources:**
- **official**: Builtin tools (e.g., web search, code sandbox), Composio integrations (e.g., Gmail, Google Calendar), and MasterLionSkill providers
...
**Notes:**
- Some official plugins (Composio, MasterLionSkill) may require OAuth authorization
