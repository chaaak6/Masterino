...
export const OFFICIAL_URL = 'https://aihub.bielcrystal.com';
...
export const GITHUB = 'https://github.com/chaaak6/Masterino';
...
export const AGENTS_OFFICIAL_URL = 'https://aihub.bielcrystal.com/agent';
...
export const BASE_PROVIDER_DOC_URL = 'https://aihub.bielcrystal.com/docs/usage/providers';
