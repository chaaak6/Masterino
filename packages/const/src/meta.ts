...
export const MASTERLION_AGENT_AVATAR = '/brand/masterlion/avatar.png';
export const DEFAULT_INBOX_TITLE = '小宗狮AI';
export const DEFAULT_INBOX_AVATAR = MASTERLION_AGENT_AVATAR;
