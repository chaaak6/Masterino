export default {
  ...
  'notSupportGuide.desc':
    'The current deployment mode does not support file management. Switch to <1>server database deployment mode</1>, or use <3>MasterLion Cloud</3>.',
  ...
  'uploadDock.body.item.chunking': 'Chunking for search...',
  'uploadDock.body.item.done': 'Uploaded',
  'uploadDock.body.item.error': 'Upload failed, please try again',
  'uploadDock.body.item.error.chunk': 'Uploaded, but chunking failed',
  'uploadDock.body.item.error.embedding': 'Uploaded, but vectorization failed',
  'uploadDock.body.item.error.parse': 'Uploaded, but file analysis failed',
  'uploadDock.body.item.error.record': 'Uploaded, but file record creation failed',
  'uploadDock.body.item.error.storage': 'Object storage upload failed',
  'uploadDock.body.item.embedding': 'Vectorizing...',
  ...
  'uploadDock.body.item.saving': 'Saving file record...',
