export default {
  ...
  'assistants.status.support':
    'For any questions, please copy the link and send it to <email>support@bielcrystal.com</email> for assistance.',
  'assistants.status.unpublished.subtitle':
    'This Agent is under review. To confirm its status, copy the link and email <email>support@bielcrystal.com</email>.',
  ...
  'createGuide.func1.title': 'Submit in MasterLion',
  ...
  'footer.desc':
    'Evolve with AI users worldwide. Become a creator to submit your agents and skills to the MasterLion Community.',
  'footer.title': 'Share your creation on MasterLion Community today',
  ...
  'models.providerInfo.apiTooltip': 'MasterLion supports using a custom API key for this provider.',
  ...
  'models.providerInfo.officialTooltip': 'MasterLion Official Service',
  ...
  'skills.details.sidebar.platform.layout.lobehub': 'Skills are managed by MasterLion automatically',
  ...
  'skills.details.sidebar.platform.steps.lobehub':
    'Install directly from the MasterLion marketplace with one click.',
