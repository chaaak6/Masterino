export default {
  ...
  'createGuide.func1.title': 'Submit in Masterion',
  ...
  'footer.desc':
    'Evolve with AI users worldwide. Become a creator to submit your agents and skills to the Masterion Community.',
  'footer.title': 'Share your creation on Masterion Community today',
  ...
  'models.providerInfo.apiTooltip': 'Masterion supports using a custom API key for this provider.',
  ...
  'models.providerInfo.officialTooltip': 'Masterion Official Service',
  ...
  'skills.details.sidebar.platform.layout.lobehub': 'Skills are managed by Masterion automatically',
  ...
  'skills.details.sidebar.platform.steps.lobehub':
    'Install directly from the Masterion marketplace with one click.',
