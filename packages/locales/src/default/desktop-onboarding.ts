export default {
  ...
  'screen4.share.description':
    'Share anonymized usage data to help us improve Masterion. This helps us understand how Agents are used and make them better.',
  ...
  'screen4.share.title': 'Help Improve Masterion',
  ...
  'screen5.actions.signInCloud': 'Sign in to Masterion Cloud',
  ...
  'screen5.methods.cloud.description':
    'Sign in with your Masterion Cloud account to sync everything seamlessly',
  'screen5.methods.cloud.name': 'Masterion Cloud',
  'screen5.methods.selfhost.description': 'Connect to your own Masterion server instance',
