export default {
  ...
  'screen4.share.description':
    'Share anonymized usage data to help us improve MasterLion. This helps us understand how Agents are used and make them better.',
  ...
  'screen4.share.title': 'Help Improve MasterLion',
  ...
  'screen5.actions.signInCloud': 'Sign in to MasterLion Cloud',
  ...
  'screen5.methods.cloud.description':
    'Sign in with your MasterLion Cloud account to sync everything seamlessly',
  'screen5.methods.cloud.name': 'MasterLion Cloud',
  'screen5.methods.selfhost.description': 'Connect to your own MasterLion server instance',
