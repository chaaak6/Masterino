export default {
  ...
  'claudeCodeInstallGuide.reason': 'Masterion could not start Claude Code: {{message}}',
  ...
  'codexInstallGuide.reason': 'Masterion could not start Codex: {{message}}',
  ...
  'gatewayMode.desc':
    "Run agents in the cloud through Masterion's Agent Gateway. Tasks keep running even after you close the page.",
  ...
  'plus.search.appSearchDesc':
    'Masterion optimized search service, delivering best retrieval results.',
  ...
  'sharePage.menu.goToLobeHub': 'Go to Masterion',
  'sharePage.menu.more': 'More',
  'sharePage.menu.report': 'Report',
  'sharePageDisclaimer':
    "Shared by a user. The content reflects their views, not Masterion's, and Masterion takes no responsibility for it.",
  ...
  'taskList.unassignedHint': 'Masterion will run this task when no assignee is set',
  ...
  'upload.parseFailedDesc':
    '{{filename}} was uploaded, but Masterion could not extract its text. This is not an object storage upload failure. Remove the file and upload it again before sending.',
