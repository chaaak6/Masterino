export default {
  ...
  'claudeCodeInstallGuide.reason': 'MasterLion could not start Claude Code: {{message}}',
  ...
  'gatewayMode.desc':
    "Run agents in the cloud through MasterLion's Agent Gateway. Tasks keep running even after you close the page.",
  ...
  'plus.search.appSearchDesc':
    'MasterLion optimized search service, delivering best retrieval results.',
  ...
  'sharePage.menu.goToLobeHub': 'Go to MasterLion',
  'sharePage.menu.more': 'More',
  'sharePage.menu.report': 'Report',
  'sharePageDisclaimer':
    "Shared by a user. The content reflects their views, not MasterLion's, and MasterLion takes no responsibility for it.",
  ...
  'taskList.unassignedHint': 'MasterLion will run this task when no assignee is set',
  ...
  'upload.parseFailedDesc':
    '{{filename}} was uploaded, but MasterLion could not extract its text. This is not an object storage upload failure. Remove the file and upload it again before sending.',
