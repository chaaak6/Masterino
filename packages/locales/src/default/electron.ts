export default {
  ...
  'remoteServer.configDesc': 'Connect to the remote Masterion server to enable data synchronization',
  ...
  'sync.lobehubCloud.title': 'Masterion Cloud',
