export default {
  ...
  'remoteServer.configDesc': 'Connect to the remote MasterLion server to enable data synchronization',
  ...
  'sync.lobehubCloud.title': 'MasterLion Cloud',
