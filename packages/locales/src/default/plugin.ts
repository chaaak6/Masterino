export default {
  ...
  'protocolInstall.official.badge': 'Masterion Official Skill',
  'protocolInstall.official.description':
    'Official Masterion Skill, verified and security-checked.',
  ...
  'skillDetail.trustWarning':
    "Only use connectors from developers you trust. Masterion does not control which tools developers make available and cannot verify that they will work as intended or that they won't change.",
  'skillInstallBanner.dismiss': 'Dismiss',
  'skillInstallBanner.title': 'Connect your favorite apps to Masterion',
  ...
  'store.tabs.mcp': 'MCP',
  'store.tabs.old': 'Masterion Skills',
