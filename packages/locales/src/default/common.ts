export default {
  ...
  'messengerBanner.title': 'Talk to Masterino on your favorite messaging apps',
  'branching': 'Create Subtopic',
  'branchingDisable':
    'The "Sub-topic" feature is unavailable in the current mode. To use this feature, please switch to Postgres/Pglite DB mode or use Masterino Cloud.',
  ...
  'productFeatures.backToChat': 'Back to chat',
  'productFeatures.disabled': '敬请期待',
  'productFeatures.disabledDescription': '敬请期待',
  'productFeatures.disabledTitle': '敬请期待',
