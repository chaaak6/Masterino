export default {
  ...
  'newapi.apiKey.desc': 'API key provided by the Aihub platform',
  'newapi.apiKey.placeholder': 'Aihub API Key',
  'newapi.apiKey.required': 'API key is required',
  'newapi.apiKey.title': 'API Key',
  'newapi.apiUrl.desc': 'API endpoint for the Aihub service, usually includes /v1',
  'newapi.apiUrl.title': 'API URL',
  'newapi.enabled.title': 'Enable Aihub',
