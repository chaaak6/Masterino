...
const prefixes = {
  ...
  evalRuns: 'run',
  evalTestCases: 'case',
  enterpriseAuditLogs: 'eal',
  enterpriseDepartmentMembers: 'edm',
  enterpriseDepartments: 'dept',
  externalIdentities: 'xid',
  files: 'file',
  ...
  messages: 'msg',
  plugins: 'plg',
  resourceAccessControls: 'rac',
  sessionGroups: 'sg',
  sessions: 'ssn',
  ssoProviderConfigs: 'sso',
  systemConfigs: 'scfg',
  threads: 'thd',
  topics: 'tpc',
  user: 'user',
