CREATE TABLE IF NOT EXISTS "user_memories_activities" (
	...
	"notes" text,
	"narrative" text,
	"narrative_vector" halfvec(2048),
	"feedback" text,
	"feedback_vector" halfvec(2048),
...
CREATE INDEX IF NOT EXISTS "user_memories_activities_narrative_vector_index" ON "user_memories_activities" USING hnsw ("narrative_vector" halfvec_cosine_ops);--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "user_memories_activities_feedback_vector_index" ON "user_memories_activities" USING hnsw ("feedback_vector" halfvec_cosine_ops);--> statement-breakpoint
