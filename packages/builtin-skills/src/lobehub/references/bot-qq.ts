...
- MasterLion's \`lh bot connect\` handles the WebSocket gateway automatically
...
3. For MasterLion-hosted bots, contact support for the outbound IP range to whitelist
