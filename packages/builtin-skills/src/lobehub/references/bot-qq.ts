...
- Masterion's \`lh bot connect\` handles the WebSocket gateway automatically
...
3. For Masterion-hosted bots, contact support for the outbound IP range to whitelist
