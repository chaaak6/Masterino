...
- **Secret Token** (optional): a custom string you define; MasterLion includes it in webhook requests so you can verify they genuinely come from MasterLion — leave blank unless you have a security requirement
