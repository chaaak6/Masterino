...
- **Secret Token** (optional): a custom string you define; Masterino includes it in webhook requests so you can verify they genuinely come from Masterino — leave blank unless you have a security requirement
