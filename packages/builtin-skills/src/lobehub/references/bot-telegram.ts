...
- **Secret Token** (optional): a custom string you define; Masterion includes it in webhook requests so you can verify they genuinely come from Masterion — leave blank unless you have a security requirement
