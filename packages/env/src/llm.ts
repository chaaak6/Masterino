...
export const getLLMConfig = () => {
  return createEnv({
    server: {
      ...
      AIHUB_ADMIN_ACCESS_TOKEN: z.string().optional(),
      AIHUB_ADMIN_USER_ID: z.string().optional(),
      AIHUB_BRIDGE_TOKEN: z.string().optional(),
      AIHUB_BRIDGE_URL: z.string().optional(),
      AIHUB_DATA_SOURCE: z.string().optional(),
      AIHUB_DEFAULT_MODEL: z.string().optional(),
      AIHUB_HIDDEN_MODELS: z.string().optional(),
      AIHUB_MANAGED_TOKEN_NAME: z.string().optional(),
      AIHUB_PROXY_URL: z.string().optional(),
      AIHUB_READONLY_DATABASE_URL: z.string().optional(),
      AIHUB_USAGE_PAGE_SIZE: z.coerce.number().optional(),
    ...
    runtimeEnv: {
      ...
      ENABLED_NEWAPI: !!process.env.AIHUB_PROXY_URL,
      AIHUB_ADMIN_ACCESS_TOKEN: process.env.AIHUB_ADMIN_ACCESS_TOKEN,
      AIHUB_ADMIN_USER_ID: process.env.AIHUB_ADMIN_USER_ID,
      AIHUB_BRIDGE_TOKEN: process.env.AIHUB_BRIDGE_TOKEN,
      AIHUB_BRIDGE_URL: process.env.AIHUB_BRIDGE_URL,
      AIHUB_DATA_SOURCE: process.env.AIHUB_DATA_SOURCE,
      AIHUB_DEFAULT_MODEL: process.env.AIHUB_DEFAULT_MODEL,
      AIHUB_HIDDEN_MODELS: process.env.AIHUB_HIDDEN_MODELS,
      AIHUB_MANAGED_TOKEN_NAME: process.env.AIHUB_MANAGED_TOKEN_NAME,
      AIHUB_PROXY_URL: process.env.AIHUB_PROXY_URL,
      AIHUB_READONLY_DATABASE_URL: process.env.AIHUB_READONLY_DATABASE_URL,
      AIHUB_USAGE_PAGE_SIZE: process.env.AIHUB_USAGE_PAGE_SIZE,
