...
export const getAuthConfig = () => {
  return createEnv({
    ...
    server: {
      ...
      AUTH_WECOM_AGENT_ID: z.string().optional(),
      AUTH_WECOM_CORP_ID: z.string().optional(),
      AUTH_WECOM_CORP_SECRET: z.string().optional(),
    ...
    runtimeEnv: {
      ...
      AUTH_WECOM_AGENT_ID: process.env.AUTH_WECOM_AGENT_ID,
      AUTH_WECOM_CORP_ID: process.env.AUTH_WECOM_CORP_ID,
      AUTH_WECOM_CORP_SECRET: process.env.AUTH_WECOM_CORP_SECRET,
