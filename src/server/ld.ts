...
export const AUTHOR_LIST = {
  ...
  lobehub: {
    avatar: '/brand/masterlion/logo.png',
...
export class Ld {
  ...
  genOrganization() {
    return {
      ...
      'description': `${BRANDING_NAME} is the internal AI chat workspace for ${ORG_NAME} teams.`,
      'email': BRANDING_EMAIL.business,
      'founders': [],
      'image': urlJoin(BRAND_SITE_URL, '/brand/masterlion/logo.png'),
      'logo': {
        '@type': 'ImageObject',
        'height': 512,
        'url': urlJoin(BRAND_SITE_URL, '/brand/masterlion/logo.png'),
        'width': 512,
      },
      'name': BRANDING_NAME,
