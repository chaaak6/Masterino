  ...
  it('collects src from images and fileUrl from files, recursively', () => {
    const json = {
      root: {
        children: [
          {
            children: [image('https://aihub.bielcrystal.com/f/file_nested')],
            type: 'paragraph',
          },
          file('https://aihub.bielcrystal.com/f/file_pdf', 'doc.pdf'),
        ],
      },
    };
    expect(collectAttachmentUrlsFromEditorData(json)).toEqual([
      'https://aihub.bielcrystal.com/f/file_nested',
      'https://aihub.bielcrystal.com/f/file_pdf',
    ]);
  });
