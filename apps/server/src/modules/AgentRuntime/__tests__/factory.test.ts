...
const {
  ...
  mockAppEnv: {
    ...
    AGENT_GATEWAY_URL: 'https://aihub.bielcrystal.com',
...
describe('AgentRuntime factory', () => {
  ...
  describe('createStreamEventManager', () => {
    beforeEach(() => {
      ...
      mockAppEnv.AGENT_GATEWAY_URL = 'https://aihub.bielcrystal.com';
    });
    ...
    it('wraps with GatewayStreamNotifier when AGENT_GATEWAY_SERVICE_TOKEN is set', () => {
      ...
      expect(result.url).toBe('https://aihub.bielcrystal.com');
    });
