...
Masterino command-line interface for local development, automation, and server interaction.
...
By default the CLI connects to `https://aihub.bielcrystal.com`. To point it at a different server, such as a local Masterino instance:
