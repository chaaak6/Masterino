...
show_message() {
    ...
    case $key in
        ...
        tips_regen_jwks)
            case $LANGUAGE in
                zh_CN)
                    echo "在完成部署测试后，请前往 https://aihub.bielcrystal.com/zh/docs/self-hosting/environment-variables/auth#jwks_key 生成新的 JWKS_KEY 并替换 .env 中的值，以确保安全性。"
                ;;
                *)
                    echo "After completing the deployment test, please go to https://aihub.bielcrystal.com/docs/self-hosting/environment-variables/auth#jwks_key to generate a new JWKS_KEY and replace the value in .env to ensure security."
                ;;
            esac
        ;;
        ...
        tips_show_documentation_url)
            case $LANGUAGE in
                zh_CN)
                    echo "https://aihub.bielcrystal.com/zh/docs/self-hosting/environment-variables"
                ;;
                *)
                    echo "https://aihub.bielcrystal.com/docs/self-hosting/environment-variables"
                ;;
            esac
        ;;
        tips_no_executable)
        ...
        ask_deploy_mode)
            case $LANGUAGE in
                zh_CN)
                    ...
                    echo "https://aihub.bielcrystal.com/docs/self-hosting/server-database/docker-compose"
                ;;
                *)
