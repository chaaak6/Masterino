...
Required for mutating commands:
  ...
  MASTERLION_IMAGE_DIGEST    Immutable sha256: digest for MasterLion v0.0.13.
  BRIDGE_IMAGE_DIGEST        Immutable sha256: digest for Aihub DB Bridge v0.0.13.
