...
const AUTH_SECRET_DOC_URL =
  'https://aihub.bielcrystal.com/docs/self-hosting/environment-variables/auth#auth-secret';
const KEY_VAULTS_SECRET_DOC_URL =
  'https://aihub.bielcrystal.com/docs/self-hosting/environment-variables/basic#key-vaults-secret';
