...
MasterLion 帮你把专属 Agent 组织成 7×24 不打烊的高效队伍：
...
不论普通用户与专业开发者，MasterLion 旨在成为所有人的 AI Agent 实验场。MasterLion 目前正在积极开发中，有任何需求或者问题，欢迎提交 [issues][issues-link]

| [![](https://api.producthunt.com/widgets/embed-image/v1/featured.svg?post_id=1065874&theme=light&t=1769347414733)](https://www.producthunt.com/products/lobehub?launch=lobehub-2&embed=true&utm_source=badge-featured&utm_medium=badge&utm_campaign=badge-lobehub) | 我们已在 Product Hunt 上线！我们很高兴将 MasterLion 推向世界。如果您相信人类与 Agent 共同进化的未来，请支持我们的旅程。 |
| :----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | :------------------------------------------------------------------------------------------------------------------- |
| [![][discord-shield-badge]][discord-link]                                                                                                                                                                                                                          | 加入我们的 Discord 社区！这是你可以与开发者和其他 MasterLion 热衷用户交流的地方                                         |
...
MasterLion 是一个工作与生活空间，用于发现、构建并与会随着您一起成长的 Agent 队友协作。在 MasterLion 中，我们将 **Agent 视为工作单元**，提供一个让人类与 Agent 共同进化的基础设施。
...
MasterLion 引入了 **Agent Groups**，让您可以像对待真实队友一样与 Agent 协同工作。系统会为任务组装合适的 Agent，支持并行协作与迭代改进。
...
最好的 AI 是能深入理解您的那一种。MasterLion 提供了构建清晰用户理解的 **个人记忆（Personal Memory）**。
...
MasterLion 提供了 Vercel 的 自托管版本 和 [Docker 镜像][docker-release-link]，这使你可以在几分钟内构建自己的聊天机器人，无需任何基础知识。

> \[!TIP]
>
> 完整教程请查阅 [📘 构建属于自己的 MasterLion][docs-self-hosting]
...
我们提供了一个用于在您自己的私有设备上部署 MasterLion 服务的 Docker 镜像。请使用以下命令启动 MasterLion 服务：
...
API Key 是使用 MasterLion 进行大语言模型会话的必要信息，本节以 OpenAI 模型服务商为例，简要介绍获取 API Key 的方式。
...
- 将此 API Key 填写到 MasterLion 的 API Key 配置中，即可开始使用。
...
| [@lobehub/lint][lobe-lint-link]   | [lobehub/lobe-lint][lobe-lint-github]   | MasterLion 代码样式规范 ESlint，Stylelint，Commitlint，Prettier，Remark 和 Semantic Release | [![][lobe-lint-shield]][lobe-lint-link]   |
...
插件提供了扩展 MasterLion [Function Calling][docs-function-call] 能力的方法。可以用于引入新的 Function Calling，甚至是新的消息结果渲染方式。如果你对插件开发感兴趣，请在 Wiki 中查阅我们的 [📘 插件开发指引][docs-plugin-dev] 。
...
- [@lobehub/chat-plugin-sdk][chat-plugin-sdk]：插件 SDK 可帮助您创建出色的 MasterLion 插件。
- [@lobehub/chat-plugins-gateway][chat-plugins-gateway]：插件网关是一个后端服务，作为 MasterLion 插件的网关。我们使用 Vercel 部署此服务。主要的 API POST /api/v1/runner 被部署为 Edge Function。
...
> 同时欢迎联系我们提供产品功能和使用体验反馈，帮助我们将 MasterLion 建设得更好。
>
...
Copyright © 2025 [MasterLion][profile-link]. <br />
This project is [MasterLion Community License](./LICENSE) licensed.

<!-- LINK GROUP -->

[back-to-top]: https://img.shields.io/badge/-BACK_TO_TOP-151515?style=flat-square
[blog]: https://aihub.bielcrystal.com/zh/blog
...
[docs]: https://aihub.bielcrystal.com/zh/docs/usage/start
[docs-dev-guide]: https://aihub.bielcrystal.com/docs/development/start
[docs-docker]: https://aihub.bielcrystal.com/zh/docs/self-hosting/server-database/docker-compose
[docs-env-var]: https://aihub.bielcrystal.com/docs/self-hosting/environment-variables
[docs-function-call]: https://aihub.bielcrystal.com/zh/blog/openai-function-call
...
[vercel-link]: https://chat-preview.aihub.bielcrystal.com
